...
Steem ist eine Blockchain-Datenbank, die Community Building und soziale Interaktion mit Kryptowährungen unterstützt. Steem verbindet Konzepte aus sozialen Medien mit den Lehren aus dem Aufbau von Kryptowährungen und ihren Communities. Ein wichtiger Schlüssel zur inspirierenden Teilnahme in jeder Gemeinschaft, Währung oder freie Marktwirtschaft ist ein faires Abrechnungssystem, das konsequent den Beitrag jeder Person widerspiegelt. Steem ist die erste Kryptowährung, die versucht, eine unbegrenzte Anzahl von Individuen, die *subjektive Beiträge* zu ihrer Gemeinschaft leisten, genau und transparent zu belohnen.
...
Steem ist von Grund auf darauf ausgelegt, die größten Hindernisse für die Akzeptanz und Monetarisierung einer auf Social Media basierenden Wirtschaft zu beseitigen. Unsere These ist, dass die gleichen Techniken, mit denen die wichtigsten Social Media Plattformen wachsen, verwendet werden können, um eine erfolgreiche Kryptowährung zu starten. Wirtschaftliche Anreize, die durch Kryptowährung ermöglicht werden, können das Wachstum einer neuen Social Media-Plattform erheblich begünstigen. Es ist die Synergie zwischen Kryptowährung und Social Media, von der wir glauben, dass sie Steem einen starken Vorteil auf dem Markt verschaffen kann.

Die Herausforderung für Steem besteht darin, einen Algorithmus für die Bewertung einzelner Beiträge abzuleiten, den die meisten Community-Mitglieder als eine faire Bewertung des subjektiven Wertes jedes Beitrags betrachten. In einer perfekten Welt würden die Mitglieder der Gemeinschaft zusammenarbeiten, um den Beitrag des anderen zu bewerten und eine faire Vergütung zu erhalten. In der realen Welt müssen Algorithmen so konzipiert sein, dass sie gegen absichtliche Manipulationen aus Profitgründen resistent sind. Jeder weit verbreitete Missbrauch des Bewertungssystems könnte dazu führen, dass die Mitglieder der Gemeinschaft den Glauben an die wahrgenommene Fairness des Wirtschaftssystems verlieren.

Bestehende Plattformen agieren auf einem "ein Nutzer – eine Stimme"-Prinzip. Dies schafft eine Umgebung, in der Rankings durch Sybil-Angriffe manipuliert werden können und die Dienstleister proaktiv Täter identifizieren und blockieren müssen. Menschen haben bereits versucht die Bewertungs-Algorithmen von Reddit, Facebook und Twitter zu manipulieren, obwohl Internet-Datenverkehr oder Zensur die einzige Belohnung dafür ist.

Die grundlegende Account-Einheit auf der Steem-Plattform ist STEEM, ein Krypto-Währungs-Token. Steem arbeitet auf der Basis "ein STEEM – eine Stimme". Nach diesem Modell haben Personen, die, gemessen an ihrem Kontostand, den größten Beitrag zur Plattform geleistet haben, den größten Einfluss darauf, wie die Beiträge bewertet werden. Darüber hinaus erlaubt Steem den Mitgliedern nur dann, mit STEEM abzustimmen, wenn sie sich einem mehrjährigen Sperrzeitraum verpflichtet haben. Nach diesem Modell haben die Mitglieder einen finanziellen Anreiz, in einer Weise abzustimmen, die den langfristigen Wert ihres STEEM maximiert.

Steem ist auf ein relativ einfaches Konzept ausgelegt: *jeder sinnvolle Beitrag für die Gemeinschaft sollte für den Mehrwert anerkannt werden, den er bringt.* Wenn Menschen für ihre sinnvollen Beiträge anerkannt werden, leisten sie weiterhin einen Beitrag und die Gemeinschaft wächst. Jedes Ungleichgewicht im Geben und Nehmen innerhalb einer Gemeinschaft ist nicht nachhaltig. Schließlich werden die Geber der Unterstützung der Nehmer müde und steigen aus der Community aus.

Die Herausforderung besteht darin, ein System zu schaffen, das in der Lage ist, die benötigten Beiträge und deren relativen Wert so zu identifizieren, dass sie auf eine unbegrenzte Anzahl von Menschen skalierbar sind.

Ein erprobtes System für die Evaluierung und Belohnung von Beiträgen ist der freie Markt. Der freie Markt kann als einzelne Gemeinschaft gesehen werden, wo jeder mit jedem handeln kann und Belohnungen nach Gewinn oder Verlust bemessen werden. Das Markt-System belohnt jene, die einen Mehrwert für andere liefern und bestraft solche, die mehr konsumieren als sie produzieren. Der freie Markt unterstützt viele verschiedene Währungen und Geld ist einfach eine Ware, die jeder ganz einfach eintauschen kann.

...
Sporedni efekat povećanja zaliha je taj da će mreža zahtevati povećanje nivoa preciznosti u svom računovodstvu. U proseku, broj bita koji je potreban da predstavi tipičan račun će narasti za 1.3 godišnje. Trebaće samo 10 godina pre nego što brojevi koji su u igri prestanu da odgovaraju 53-bitnoj preciznosti koju podržava JavaScript ili 64-bitnoj preciznosti koju podržavaju procesori. Over time the magnitude of the numbers involved grows beyond human scale and comprehension; furthermore, the least significant bits have so little economic value as to render them meaningless.

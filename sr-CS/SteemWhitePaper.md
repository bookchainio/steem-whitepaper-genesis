...
Zbog toga što se 90% svih kreiranih STEEM-a distribuira onima koji poseduju SP, rezultat je sličan kao kada bi svake godine postojalo deljenje u odnosu 2:1, pre nego prava inflacija. The total rate of expenditures used to reward contributors is about 10% of the market capitalization per year, a rate well below what Bitcoin sustained for the first 7 years after it launched.

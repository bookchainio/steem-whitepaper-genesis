...
Mối quan ngại chính của các nhà cung cấp dữ liệu đồng Steem là duy trì giao dịch một-một-một ổn định giữa SMD và Đô la Mỹ (USD). Bất cứ lúc nào SMD liên tục giao dịch trên $1.00 USD thì thanh toán lãi suấtphải được ngưng lại. Trong một thị trường mà lãi suất 0% nợ mà vẫn yêu cầu một phí bảo hiểm, có thể an tâm nói rằng thị trường sẵn sàng mở rộng các khoản tín dụng nhiều hơn so với các khoản nợ mà cộng đồng sẵn sàng chấp nhận. Nếu điều này xảy ra, SMD sẽ có giá trị hơn $1.00 và sẽ có rất ít điều cộng đồng có thể làm mà không tính phí lãi suất âm.

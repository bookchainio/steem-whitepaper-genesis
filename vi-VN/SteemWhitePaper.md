...
Hãy thử tưởng tượng hằng ngày chúng ta sử dụng một trang mạng nào đó nhưng họ lại đòi chúng ta phải trả phí mỗi khi chúng ta muốn thay đổi mật khẩu cho tài khoản của mình. Rõ ràng là người dùng luôn muốn được miễn phí. Requiring users to make a decision on whether or not an action is worth a small fee creates anxiety that causes users to leave.

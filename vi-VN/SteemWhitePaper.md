...
Mỗi giá trị một đồng tiền mang lại phụ thuộc vào nhu cầu dành ảnh hưởng trong phạm vi một cộng đồng và niềm tin của thị thường về khả năng phát triển của cộng đồng đó. Khác với các hệ thống được sử dụng trước đây, ưu điểm của bằng chứng công việc chủ quan là giúp một cộng đồng gây quỹ một cách kỹ càng đối với các dự án có giá trị và tạo ra khả năng kiếm tiền từ các khoảng thời gian vô nghĩa trước đây.

### Phân phối tiền tệ

Có hai cách cơ bản để mọi người có thể bắt đầu bước chân vào cộng đồng tiền mã hóa, đó là: *mua* chúng, hoặc là *hoàn thành các công việc*. Mặc dù cả hai cách trên đều mang lại giá trị cho tiền tệ, nhưng phần lớn mọi người đều có nhiều *thời gian rảnh rỗi hơn* là có các *khoản tiền nhàn rỗi*. Hãy thử nghĩ đến việc tạo ra tiền tệ cho một cộng đồng nghèo không có *tiền mặt* nhưng lại có rất nhiều *thời gian*. Nếu mọi người có thể kiếm tiền bằng cách làm việc cho người khác sau đó xây dựng giá trị thông qua sàn giao dịch chung được vận hành dễ dàng nhờ một hệ thống tài chính/tiền tệ công bằng.

Việc phân phối một đồng tiền tới nhiều người nhất có thể được coi là một nhiệm vụ tương đối thử thách. Và các nhiệm vụ này được đánh giá bởi một thuật toán máy tính khách quan với nhiều giới hạn tác động, hay nói chung là hạn chế các lợi ích tích cực từ bên ngoài. Trong trường hợp khai thác theo như của Bitcoin, nó có thể dẫn đến việc sản xuất ra các thiết bị phần cứng đặc thù chuyên dụng và khiến người ta phải tiếp tục đầu tư thời gian để phát triển thêm các thuật toán hiệu quả hơn. Nó có thể giúp tìm ra những kết quả tốt nhất, nhưng những con số này không mang lại giá trị ý nghĩa gì cho xã hội hay toàn bộ cộng đồng đang nắm giữ đồng tiền này. Điều quan trọng hơn, sự mở rộng của các nền kinh tế và các sức mạnh của thị trường sẽ dẫn đến việc loại trừ tất cả mọi người ra ra khỏi cuộc chơi nhưng chỉ còn những chuyên gia tham gia vào việc phân phối này. Cuối cùng, việc khai thác dự trên các thiết bị tính toán chỉ là cách gọi khác của việc *mua vào* bởi vì nó yêu cầu dùng tiền để thanh toán hóa đơn tiền điện và nâng cấp các thiết bị phần cứng cần thiết để thực hiện công việc khai thác này.

Để giúp cho mọi người có cơ hội như nhau để tham gia và nhận đồng tiền này thì ai cũng phải được trao cơ hội để làm việc như nhau. Thử thách ở đây là làm sao đánh giá được số lượng và chất lượng tương xứng của công việc mà mỗi cá nhân được giao cho và thực hiện để có thể phân phối hiệu quả các phần thưởng cho hàng triệu người dùng. Để thực hiện điều này cần đưa ra cách thức bỏ phiếu mới có tính linh hoạt. Nói một cách cụ thể hơn, nó cần một cơ cấu quản lý có tính phân tán và phi tập trung nhất có thể nhằm giúp phân chia các quỹ.

Bước đầu tiên cho việc trả thưởng tới hàng triệu người dùng là đảm bảo một lượng tiền nhất định được phân bổ cho bất kỳ công việc nào được hoàn thành hoặc việc mọi người dùng bỏ lượng phiếu như thế nào. Điều này khiến thay đổi câu hỏi từ *“Chúng ta có nên trả tiền không?”* sang câu *”Chúng ta nên trả tiền cho ai?”* và gửi tín hiệu cho thị trường biết dòng tiền đang được phân phối và đang được đấu giá để trao cho người hoàn thành được nhiều *công việc* nhất. Việc này tương tự như Bitcoin đã từng làm là cam kết tặng thưởng 50BTC cho bất kỳ ai giải được những hàm băm khó nhất. Như với Bitcoin, mọi công việc phải được hoàn thành trước khi nhận thù lao và không có một khoản tiền ước lượng nào được trả trước với sự hứa hẹn hoàn thành công việc trong tương lai.

Bước tiếp theo là trao thưởng cho những ai làm bất cứ điều gì và kể cả từ xa nhưng ảnh hưởng tích cực đến *một vài thứ*. Tất cả các công việc khi hoàn thành sẽ được xếp hạng và phần thưởng được phân phối theo từng phần tùy theo giá trị của nó. Thị trường càng có tính cạnh tranh cao, cơ hội nhận mức thù lao như cũ càng trở nên khó hơn (với chất lượng hoặc số lượng gia tăng).
...
Hiện nay cách truyền tải thông tin dễ dàng nhất trên toàn thế giới là sử dụng Internet. With that said, it can be a frightening place for content creators who would like to own their content and have it shared with proper attribution. On current social media platforms, attribution is something that can be lost overnight - a posted video or image can be replicated and re-shared without consent or regard for the creator.

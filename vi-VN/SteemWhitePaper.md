...
Nguyên tắc thứ ba nêu lên cộng đồng hoạt động để phục vụ cộng đồng và các thành viên của họ. Các tổ chức tín dụng, các tập đoàn liên kết và các chương trình chia sẻ chăm sóc sức khỏe là ví dụ điển hình cho nguyên tắc này; mục đích của họ không đơn thuần là cung cấp hàng hóa và dịch vụ ra các đối tác bên ngoài mà hoạt động để phục vụ cho chính các thành viên trong tổ chức.

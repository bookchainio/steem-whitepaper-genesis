...
Có hai cách cơ bản để mọi người có thể bắt đầu bước chân vào cộng đồng tiền mã hóa, đó là: *mua* chúng, hoặc là *hoàn thành các công việc*. Mặc dù cả hai cách trên đều mang lại giá trị cho tiền tệ, nhưng phần lớn mọi người đều có nhiều *thời gian rảnh* hơn là có các *khoản tiền nhàn rỗi*. Hãy thử nghĩ đến việc tạo ra tiền tệ cho một cộng đồng nghèo không có *tiền mặt* nhưng lại có rất nhiều *thời gian* để làm việc. Vậy thì mọi người có thể kiếm tiền bằng cách làm việc cho người khác từ đó tạo giá trị cho đồng tiền đó thông qua sàn giao dịch chung được quản lý bởi hệ thống tài chính/tiền tệ công bằng.

Một nhiệm vụ tương đối thử thách được đặt ra là làm sao phân phối tiền tệ tới nhiều người nhất có thể. Những nhiệm vụ này có thể hoàn toàn được đánh giá bởi thuật toán máy tính khách quan khiến bị hạn chế nhiều yếu tố và nói chung sẽ giảm thiểu tác động trực tiếp từ bên ngoài. Trường hợp khai thác như kiểu Bitcoin, nó có thể dẫn đến việc sản xuất ra các thiết bị phần cứng đặc thù và đồng thời tăng thêm thời gian phát triển các thuật toán gia tăng khả năng tính toán. Nó có thể giúp tìm ra những kết quả tốt nhất, nhưng những con số này không mang lại giá trị ý nghĩa gì cho xã hội hay toàn bộ cộng đồng đang nắm giữ đồng tiền này. Điều quan trọng hơn, sự mở rộng của các nền kinh tế và các sức mạnh của thị trường sẽ dẫn đến việc loại trừ tất cả mọi người ra ra khỏi cuộc chơi nhưng chỉ còn những chuyên gia tham gia vào việc phân phối này. Cuối cùng, việc khai thác dự trên các thiết bị tính toán chỉ là cách gọi khác của việc *mua vào* bởi vì nó yêu cầu dùng tiền để thanh toán hóa đơn tiền điện và nâng cấp các thiết bị phần cứng cần thiết để thực hiện công việc khai thác này.

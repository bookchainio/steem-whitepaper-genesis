...
Steem, một dạng token tiền kỹ thuật số, cũng là đơn vị tiền tệ cơ bản của hệ thống Steem. Nguyên tắc hoạt động của Steem là mỗi một Steem tương ứng với một phiếu bình chọn. Căn cứ trên nguyên tắc này thì cá nhân nào có nhiều đóng góp nhất cho cộng đồng và thu về nhiều giá trị trong số dư tài khoản sẽ là người có tầm ảnh hưởng nhất tới việc đánh giá và bình bầu nội dung. Furthermore, Steem only allows members to vote with STEEM when it is committed to a multi-year vesting schedule. Under this model, members have a financial incentive to vote in a way that maximises the long term value of their STEEM.

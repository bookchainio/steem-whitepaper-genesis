...
Quy trình bỏ phiếu đơn giản này dẫn đến cái gọi là “Tình trạng tiến thoái lưỡng nan của tù nhân”, có nghĩa là mọi người đều có động cơ tự "vote" cho mình, điều này là đi ngược lại với mục tiêu phát triển của toàn bộ cộng đồng. If every voter defects by voting for themselves then no currency will end up distributed and the currency as a whole will fail to gain network effect. On the other hand, if only one voter defects then that voter would win undeserved profits while having minimal effect on the overall value of the currency.

...
Biểu đồ này cho thấy những thay đổi trong thời gian bỏ phiếu hiệu quả sau khi các phiếu bầu thuận và nghịch mới được áp dụng. New votes extend the payout period in proportion to how large they are relative to all votes that have gone before. Around time 40 a large number of new votes were added which extended the voting period by 12 hours, subsequent smaller votes had far less impact on the voting period.

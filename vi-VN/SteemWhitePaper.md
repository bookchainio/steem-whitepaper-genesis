...
Đó là một quyền lợi đáng kể để người dùng cam kết hợp tác lâu dài, bởi nó cho phép những cộng đồng thực hiện những kế hoạch dài hạn. Sự cam kết gắn bó lâu dài của các bên liên quan cũng giúp họ bỏ phiếu cho sự phát triển dài hạn, hơn là những cuộc thu mua ngắn hạn.
...
Gọi B là băng thông trung bình của người dùng tại thời điểm T. Gọi W là số giây mỗi tuần và gọi N là lượng giao dịch mới diễn ra trong S giây sau thời điểm T. Với thông tin này blockchain có thể tính băng thông trung bình mới cho người dùng là:
...
Mỗi người dùng được sử dụng băng thông trung bình hàng tuần là:
    ...
    Gọi S = tổng số SP
    Gọi R = tỷ lệ dự trữ hiện tại giữa 1 và tỷ lệ dự trữ tối đa
...
Để tính số lượng tối đa ngưởi dùng duy nhất thực hiện giao dịch một tuần một lần ta áp dụng công thức: B \ * W / T. T là lượng giao dịch trung bình. Như vậy với giả thuyết đưa ra tất cả ngưởi dùng đều có số vốn bằng nhau thì trong một lần Bitcoin có thể hỗ trợ khoảng 2 triệu người dùng thực hiện giao dịch mỗi tuần.
...
Dựa trên hệ thống tài khoản của Steem với số dư được công khai sẽ làm đơn giản hóa việc thi hành thuật toán hạn chế tần suất băng thông. Bất kỳ tài khoản có số dư dưới mức cần thiết để có thể tham gia giao dịch một lần mỗi tuần thì sẽ không được giao dịch. Điều này có nghĩa là tất cả các tài khoản mới ít nhất nên được tài trợ một khoản số dư tối thiểu này. Điều này cũng có nghĩa là người dùng có thể giao dịch với số lượng nhỏ hơn, miễn là họ có số dư lớn hơn và sử dụng lại tài khoản.
...
Khái niệm bắt buộc người dùng phải duy trì một lượng số dư tối thiểu được lưu thông một cách tự nhiên từ giá trị của người dùng [^11]. Bất kỳ ai đang có công việc kinh doanh đều biết rằng mỗi người dùng đều có giá trị đáng kể. Trong việc kinh doanh, doanh nghiệp phải chi tiêu từ $30 đến $200 để có được một khách hàng. Đôi khi, họ trả tiền trực tiếp cho người dùng, những lần khác họ trả tiền cho quảng cáo và còn những thời điểm khác thì họ mua toàn bộ công ty để đáp ứng cho cơ sở người dùng của họ. Để giữ chân người dùng gắn kết với công ty và thu lại lợi nhuận từ họ thông qua nhiều phương thức thì ngay từ thời điểm bắt đầu tiếp cận được khách hàng, một công ty thường cung cấp cho họ rất nhiều *dịch vụ miễn phí*.

Ripple sử dụng giá trị số dư thực tế nhỏ nhất là [^12] tương ứng với giá trị tài nguyên của tài khoản có thể được giao dịch và Ripple cũng yêu cầu mỗi tài khoản mới được tạo ra phải được chuyển vào ít nhất một lượng bằng số dư thực tế tối thiểu nêu trên. Hiện tại số dư tối thiểu này là vào khoảng $0.15 lớn hơn $0.10 mà chúng tôi ước tính rằng với số dư tối thiểu này sẽ cho phép một người dùng nào đó tự do giao dịch ít nhất một lần mỗi tuần.

Blockchain có thể cấp cho mỗi người dùng một giá trị tối thiểu thông qua quá trình đơn giản là yêu cầu số dư tối thiểu. Bất kỳ doanh nghiệp nào muốn đưa khách hàng mới vào blockchain đều có thể cấp vốn trước vào tài khoản của người dùng đó bằng với số dư tối thiểu mà sẽ cho phép họ được giao dịch. Việc yêu cầu một khoản phí tương đối lớn ($1.00) để đăng ký tài khoản cho người dùng mới sẽ bắt buộc những người cung cấp tài khoản miễn phí phải xem xét chặt chẽ về chất lượng và tính duy nhất của từng tài khoản trước khi đăng ký chúng vào blockchain.
...
Từ trải nghiệm công nghệ biến đổi Optanetechnology của Intel [^15] cho thấy việc lưu trữ các thông tin vào bộ nhớ là giải pháp rất khả thi. Giải pháp này được áp dụng cho các phần cứng thông thường có khả năng xử lý những bussiness logic có liên kết với Steem bằng việc lưu trữ các bài đăng vào bộ nhớ để index nội dung một cách nhanh chóng (Index là thuật ngữ dùng để chỉ quá trình con bọ tìm kiếm của bộ máy tìm kiếm Google tìm thấy dữ liệu từ 1 website sau đó lưu trữ lại, đánh giá và so sánh mức độ uy tín của dữ liệu đó). Ngay cả Google cũng lưu trữ những index của toàn bộ hệ thống internet của họ trong bộ nhớ RAM. Từ khi công nghệ blockchain ra đời bộ nhớ RAM không còn được cho là giải pháp tối ưu khi nhân rộng cơ sở dữ liệu tới nhiều máy để tránh mất dữ liệu. Khi áp dụng công nghệ biến đổi Optanetechnology bộ nhớ RAM sẽ hoạt động tốc độ hơn cũng như độ bền được tăng lên. Nói cách khác, tiềm năng phát triển về quy mô của Steem trong tương lai là rất lớn.
...
Thoạt nhìn, mức tăng 100% hàng năm trong nguồn cung cấp STEEM có thể có vẻ là siêu lạm phát và không bền vững. Những người tuân theo lý thuyết số lượng của Money[^16] thậm chí có thể kết luận rằng giá trị của STEEM phải giảm khoảng 5,6% mỗi tháng. Chúng ta biết từ vô số ví dụ trong thực tế rằng số lượng tiền không có ảnh hưởng trực tiếp và ngay lập tức đến giá trị của nó, nhưng nó vẫn đóng một vai trò nhất định.

Bởi vì 90% số STEEM được tạo ra sẽ phân phối trở lại cho chủ sở hữu của SP, kết quả là tương tự như tỉ lệ 2: 1 và "chia" mỗi năm thay vì lạm phát thực sự. Tổng tỷ lệ chi tiêu được sử dụng để thưởng cho những người đóng góp là khoảng 10% vốn hóa thị trường mỗi năm, một tỷ lệ thấp hơn mức Bitcoin duy trì trong 7 năm đầu tiên sau khi ra mắt.

Việc tạo ra STEEM mới để trả tiền khích lệ cho một người dùng cụ thể hoặc nhóm lợi ích sẽ có tác động tiêu cực đến sự cân bằng phân bổ theo tỷ lệ phần trăm số STEEM cho các người dùng khác. Nếu có chính xác 90% nguồn cung cấp STEEM được giữ trong SP, thì sẽ giảm thiểu được các tác động tiêu cực nhờ vào cơ chế SP sở hữu sẽ tương ứng với sức mạnh mà họ nhận được; Người nắm giữ nhiều SP sẽ nhận về nhiều STEEM hơn (trên lý thuyết danh nghĩa) nhưng tỷ lệ phần trăm của họ chuỗi khối (tỉ lệ cung cấp tổng thể) vẫn không thay đổi. Nếu ít hơn (hoặc nhiều hơn) 90% nguồn cung cấp STEEM được giữ nguyên là SP, thì hai hiệu ứng vẫn theo hướng đối nghịch nhau, nhưng hiệu ứng dương (âm) sẽ trở nên lớn hơn, và tổng số của hai hiệu ứng này sẽ có xu hướng kéo và cân bằng SP về hướng 90%. Điều này "kéo" không có nghĩa là giá trị SP phải giữ ở mức 90% trong thời gian dài, bởi vì người nhận phần thưởng khuyến khích sẽ (và trong một số trường hợp là bắt buột) đặt STEEM của họ trong SP, nhờ đó STEEM được giữ như SP không chỉ nhờ vào mỗi việc kéo và giữ mức 90%.

Từ tháng 8 năm 2008 đến tháng 1 năm 2009, nguồn cung ứng tiền của Mỹ[^17] đã tăng từ $ 871B lên $ 1,737B, với tỷ lệ trên 100% mỗi năm và sau đó tiếp tục tăng trưởng khoảng 20% mỗi năm cho 6 năm tới. Điều này đã nói lên với nguồn cung ứng tiền ở Mỹ đã tăng 4,59 lần trong vòng chưa đầy 7 năm. Trong cùng kỳ thời gian đó, giá trị của đồng đô la so với hàng hóa và dịch vụ đã giảm xuống dưới 10% theo chỉ số giá của chính phủ [^18]. Ví dụ thực tế này chứng minh rằng nguồn cung ứng chỉ là một yếu tố quyết định giá cả.

Giá của một mặt hàng kỹ thuật số, như STEEM, được thúc đẩy bởi cả cung và cầu. Nếu STEEM mới được phân bổ cho những người đang nắm giữ dài hạn, thì sự gia tăng cung ứng sẽ được bù đắp bởi sự nhu cầu tương ứng để giữ cân bằng. Tác động của sự thay đổi này từ nguồn cung ứng được trì hoãn lại cho đến một ngày trong tương lai khi chủ sở hữu dài hạn quyết định bán. Áp lực bán sau đó sẽ được phân bổ trong vòng 2 năm.

Khi một nhà đầu tư dài hạn quyết định thoái vốn, nguồn cung ứng của STEEM trên thị trường sẽ tăng lên và giá bị đẩy xuống. Áp lực thị trường này sẽ giảm đi khi một nhà đầu tư dài hạn mới quyết định mua STEEM và chuyển đổi nó trở lại thành SP. Do đó, chúng tôi có thể kết luận rằng giá cả sẽ bị ảnh hưởng bởi sự thay đổi do nhu cầu nắm giữ STEEM trong thời gian dài.

Trong số 100% STEEM tăng hàng năm trong từ nguồn cung cấp, 5% trong số đó là dưới dạng Steem Dollars (SMD). SMD đại diện cho một cam kết để tạo ra giá trị của một đồng đô la của STEEM trong tương lai và không ảnh hưởng đến số lượng của STEEM trên thị trường hiện nay. Sự thay đổi giữa tỷ lệ nợ với sở hữu có thể ảnh hưởng đến giá trị nhận thức của STEEM, nhưng nó không phản ánh trực tiếp vào sự sụt giảm giá trị của đồng STEEM. Nếu giá trị của Steem tăng theo thời gian, thì số lượng STEEM có thể được tạo ra trong tương lai sẽ ít hơn và sự "lạm phát" tương ứng chưa bao giờ thực sự xảy ra.

Như đã đề cập ở trên với tổng số Steem đã “chi ra” nhằm để tài trợ cho nội dung, curation, khai thác mỏ, và phần thưởng thanh khoản số tiền chỉ 10% APR hoặc 1,2% mỗi tháng. Việc chuyển nhượng tài sản tương tự có thể được thực hiện mà không có bất kỳ thay đổi nào trong việc cung cấp STEEM bằng cách thực hiện một mức lãi suất âm trên STEEM thanh khoản khoảng 10% mỗi tháng. Nói cách khác, nó có thể được thực hiện bằng cách tính phí 3% (tương tự như thẻ tín dụng) trên mỗi lần chuyển khoản và có 1% STEEM được chuyển mỗi ngày. Mạng Bitcoin chuyển khoản [^19] 400.000 BTC trong số 15.5 triệu (hoặc 2.5%) mỗi ngày.

Mục đích của STEEM luân chuyển là tạo điều kiện thay đổi quyền sở hữu giữa các chủ sở hữu dài hạn. Đánh “thuế” là cách mà nhà mạng sử dụng khi có sự thay đổi quyền sở hữu để tài trợ cho sự tăng trưởng. Thuế chuyển nhượng này có thể tránh được gần như hoàn toàn bằng cách tự động bán STEEM cho SMD mỗi tuần khi mạng chuyển SP trở lại STEEM. Do thời gian giữ STEEM là rất ngắn nên bất kỳ tác động nào của việc thay đổi số lượng cung cấp STEEM cũng không tạo ra biến động vào các khoản chi phí thị trường.

### Những tác động khi tỷ lệ tạo Token mã hóa được tạo ra cao hơn 90%

Ngày 1 tháng 5 năm 2016, đã có hơn 98,49% STEEM đã được chuyển thành SP. Điều này cho thấy nhu cầu nắm giữ cổ phiếu dài hạn là rất lớn. Trong môi trường này STEEM luân chuyển và SP được pha loãng để tài trợ phần thưởng.

Trong 2 năm đầu đời của Bitcoin, mạng lưới đã duy trì tỷ lệ lạm phát hàng năm[^20] trên 100%. Trong 5 năm đầu tiên, nó đã hơn 30%, và trong 8 năm đầu tiên, nó đã vượt quá 10%. Dựa theo công cụ để ước tính mức độ lạm phát trong tương lai bao gồm với mã nguồn Steem, sẽ đạt được tỷ lệ phát triển tức thời khoảng 12% chỉ sau 1 năm (không bao gồm tác động của hoạt động SMD).

### Thực hiện cân đối kế toán trong Steem

Sự gia tăng trong cung cấp của STEEM chủ yếu là một tạo phẩm kết toán được tạo ra với mong muốn tránh tính lãi suất âm trên STEEM luân chuyển. Lãi suất tiêu cực sẽ ảnh hưởng một cách phức tạp, và các sàn giao dịch sẽ phải điều chỉnh số dư của người dùng để tính toán tỷ lệ hoàn vốn âm của STEEM được giữ trên sàn. Bởi tính logic của blockchain theo một cách chính xác sẽ dễ phát sinh lỗi và sẽ làm phức tạp hóa việc tích hợp và chấp nhận. Do đó, STEEM đã chọn không bao giờ tính phí tài khoản, mà thay vào đó là tăng nguồn cung. Điều này sẽ đạt được kết quả kinh tế tương tự mà không buộc mọi người chấp nhận tiền gửi STEEM để thực hiện lãi suất âm trên sổ kế toán nội bộ của họ.
...
Chung quy lại, tất cả những cách tiếp cận này đều gần với phương thức thanh toán vi mô. Sự khác nhau duy nhất ở tất cả các phương thức là người thực hiện thanh toán. Họ thường không thể hiện đủ sự gắn kết trong hình thức thanh toán vi mô ở tất cả các cách thức trên. Trong quá trình tìm kiếm các nội dung để trả thưởng, các doanh nghiệp thường tập trung nhiều vào việc nên trả tiền cho ai mà bỏ qua một thực tế rằng: mọi người thu lại lợi ích từ chính các hoạt động của họ vì thế tùy vào cách nhìn nhận vấn đề thì bản thân người tham gia phải thực hiện trả thưởng hoặc sẽ không có ai phải trả tiền.

Steem hoàn toàn bỏ qua hình thức thanh toán vi mô bởi vì một khi người dùng bình chọn một bài viết nào đấy thì điều đấy có nghĩa là cộng đồng đã đồng thuận trả thưởng cho giá trị bài viết. Cho dù người tham gia có bình chọn bài viết hay không thì một lượng tiền tương tự cũng được sử dụng và nguồn quỹ sẽ không đến từ những người bình bầu nội dung.

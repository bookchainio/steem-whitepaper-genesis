...
Hiện nay công nghệ Blockchain chủ yếu dựa vào các phí giao dịch trên để ngăn chặn các cuộc tấn công mạng như Spam. Những phí này sẽ được dùng để giải quyết tất cả các vẫn đề liên quan đến giao dịch vi mô và giúp blockchain không bị lạm dụng nhằm thực hiện những giao dịch có giá trị thấp. Thật sự mà nói thì những ứng dụng phi tập trung cần miễn phí cho người dùng nếu như muốn được thay thế bằng những ứng dụng tập trung khác. Bài viết này sẽ chỉ ra những giải pháp nhằm loại bỏ các loại chi phí khi dùng Steem, đồng thời có thể mở rộng những ứng dụng phi tập trung cần thiết.

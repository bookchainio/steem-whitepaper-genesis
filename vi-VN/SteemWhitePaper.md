...
Với tập hợp các nhà sản xuất dữ liệu được chọn và đáng tin cậy, giá thực tế được sử dụng cho việc chuyển đổi có thể được tính như là giá chuyển đổi trung bình của nguồn cung cấp dữ liệu. Bằng cách này, những thiểu số từ các nhà sản xuất dữ liệu cá nhân sản xuất ngoại lệ họ có tác động tối thiểu đến sự trung bình trong thực tế trong khi đó vẫn có khả năng tác động đến danh tiếng của họ.

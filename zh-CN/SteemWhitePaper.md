...
Steem的设计目的是通过改变经济方程式来实现对所有类型的贡献进行微额付款。 读者不再需要决定他们是否想要从自己口袋中向他人付款，而是对内容点赞或踩，Steem会根据他们的投票来决定每一个奖励。 This means that people are given a familiar and widely used interface and no longer face the cognitive, nancial, and opportunity costs associated traditional micropayment and tipping platforms.

...
虽然系统期待的目标是鼓励合作以对最佳的工作分配奖励，但破坏这一目标的*滥用*应被尽量减少。 共有两种的*滥用*，最简单的一种方式就是，一个用户比其他用户购入了更多股份，另一种方式则是涉及很多持有小股份用户之间的合作。 大股东的投票影响力可能会是小股东的100甚至1000倍，这意味着相较于奖励的线性分配，大股东们更有动机会不自律的给自己投票。

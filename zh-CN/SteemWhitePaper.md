...
精明的读者都会想到，受限供应的有息资产可能会对标定的资产价值产生波动，这取决于针对同一资产，是否有赚取利息的其他机会。 由于在某一绑定美元的项目上出现了高利率，很多人会对有限供应的Steem Dollars竞价而导致其价格上升，只到它们的价值不再是1美元。 在经济学中有一个原理，叫做三元悖论[^4]，它阐述了不可能在同一时间同时满足以下三个条件：

...
这种激励结构会鼓励人们以鼓励他人参与的方式来进行贡献。它鼓励人们提出好的问题，从而使得他人可以提供有价值的答案。
...
在金融支付领域，小额费用可以接受，原因在于相比于需要支付的费用，交易金额要高的多，买方已经做出了购买的决定。 潜在的区块链应用程序的世界比金融支付要大的多，且包含了很多必要的交易，针对这些交易而收费对用户来说是不可接受的。
...
Ripple使用一个最小余额[^12]，该余额会根据账户使用的资源进行调整，且在新注册账户的时候，必须至少充值该最小余额。 现在这个最小余额大约为0.15美元，该值高于我们推算出的，能够让用户每周至少自由交易一次的0.10美元。
...
换句话说，交易费应当等同于每周交易一次所需的最低账户余额，且在一周结束时会被退还。 假定最小账户余额为1美元，且该余额允许用户一周至少交易一次。 如果某个持有1美元余额的个人希望一次性进行5笔交易，他们需要在这一周做交易前后，将余额增至5美元。
...
百分比限制有效的确保了奖励机制不会随着时间的推移而变得毫无意义，这是为了防止系统重蹈许多其他区块链的覆辙，也就是增长模式中的“减速带”，在这种模式下，初期参与者会获得高额奖励，因此系统增长很迅速，后期由于奖励机制下降至较低水平，而不足以吸引新人加入，从而使得系统增长停滞。

这些百分比常数对分配和供给的整体影响是，(大约) 每分钟800个STEEM的速率会保持一定的时间 (例如：STEEM单位)，但按百分比（例如：随着整体供应量越来越大，800个STEEM所占的比例会越来越小）而言是下降的。 当每分钟800个STEEM的速率所涉及的各个组成部分都达到各自的基于百分比的下限时，相关的组成部分就会因此而停止下降。 反过来这意味这，从长远来看，STEEM的增长率会从每分钟800个STEEM，增长到 (受时间和网络供应影响) 相应的数值，以便能够维持贡献奖励的恒定10%年增长率，同时也维持贡献奖励和能量奖励的综合且恒定的100%年增长率。 其综合效果就是STEEM的年供应量会翻倍 (但是，正如下一节所述，如果大多数用户会Power Up，这种翻倍的效果其实上是一种不转换所有权的“分割”)。
...
乍一看，每年增发100%的STEEM供应量貌似是过度通胀且不可持续的。 那些遵循货币数量理论[^16]的人甚至会做出结论，认为STEEM的价值大约每月下降5.6%。 从无数的现实世界例子中，我们知道，尽管它会起到一定作用，但货币数量并不直接对货币价值产生直接和即刻的影响。

因为创建的STEEM中有90%会被分配给SP的持有者，其导致的结果就类似于每年以2：1的比例进行 “分裂”，而不是真正的通胀。 用于奖励贡献者的总支出大约是每年市值的10%，这个比率远远低于比特币最初发行后7年内的水平。

创建新的STEEM来支付一个特定的用户或组，会对其他所有用户余额在STEEM总量中所占的比例产生负面影响。 如果STEEM供应量中正好有90%以SP方式被持有，那么贡献奖励对SP持有者余额的负面影响正好可以被能量奖励的正面效果所抵消；SP持有者获得更多的STEEM (名义上的)，但他们在链中的百分比 (按总供应量的百分比计算) 没有改变。 如果STEEM总供应量中低于(超过) 90%被以SP方式持有，这两个影响会指向相反方向，但正面 (负面) 影响会变得更大，而这两种影响会趋于把STEEM中SP的百分比拉向90%。 这个“拉动”并不意味着SP的值在长期内必须保持在90%，因为获得奖励的人会 (在有些情况下必须) 把他们的STEEM转换成SP，这就意味着， “拉向” 90%效应并非是影响SP占STEEM供应百分比比例的唯一因素。

从2008年8月到2009年1月期间，美国的货币供应量[^17]由8,710亿美元增长到17,370亿美元，其年增长率超过100%，同时在接下来的6年中，美元持续以每年20%的速度增长。 众所周知，美国货币的供应量在不到7年的时间里增长了4.59倍。 与此同时，根据政府价格指数[^18]，相对货物和服务，美元的价值下降了不到10%。 现实世界中的例子说明了，供应量只是影响价格的因素之一。

像STEEM这样的数字商品的价格，由供需双方共同推动。 如果新的STEEM被分配给了那些会长期持有它的人，那么供应量的增加会被长期持有的需求所抵消。 这种来自于供应量变化的影响会被推迟到一个未来的日期，也就是当那些长期持有者决定要出售STEEM的时候。 卖出压力会分布到2年内。

当长期持有者决定要退出时，市场中STEEM的供应量会增加，从而推动其价格下跌。 当新的长期持有者决定要购买STEEM并将其转换为SP时，这种下行压力就会被抵消。 因此我们可以得出结论，影响价格的最主要因素是，长期持有STEEM的需求变化。

在虚拟STEEM供应中的100%年增长率中，其中的5%是Steem Dollars (SMD)。 SMD代表了对在未来创建价值一美元的STEEM的承诺，且不会影响当前市场的STEEM总量。 债务和所有权比例的变化会影响STEEM的感知价值，但这并不会直接导致STEEM价值的下跌。 如果Steem的价值随着时间推移而上升，那么在将来创建的STEEM会更少，同时相应的“通胀”亦不会发生。

众所周知，用于奖励内容、策展、挖矿、和流动性的“消耗性”Steem只有10% APR，或者每月1.2%。 通过对在可流通的STEEM上实施约每月10%的负利率，可以在不改变STEEM供应量的情况下，进行同样的财富转移。 换种方式来说，这也可以通过对每笔转账收取3%手续费 (类似于信用卡)，以及对每天STEEM转账的总额收取1%的费用。 比特币网络转账金额[^19]为1550万BTC中的40万 (或每天2.5%)。

流动性STEEM的目标是促进STEEM在长期持有者之间的所有权变更。 正是这种所有权的变更，网络才得以“征税”，从而为进一步的发展注资。 由于网络会把SP转换回STEEM，通过每周自动卖出STEEM，买进SMD，这种转账税几乎可被完全避免。 总共持有STEEM的时间将会非常之短，因此就类似于市场波动性及其他市场费用，它对STEEM供应量变化的影响是微不足道的。

### 代币创建率的影响超出90%

截至到2016年5月1日，超过98.49%的STEEM被转换为SP。 这展示了长期持有STEEM的需求占据主导地位。 在这个环境下，流动性STEEM和SP均被稀释，来为奖励提供资金。

在比特币网络的最初两年，其年通胀率[^20]超过100%。 在最初5年，其年通胀率超过30%，在最初8年，其年通胀率超过10%。 根据Steem源代码中包含的未来通胀的估算工具，Steem在一年之后 (不考虑SMD操作产生的影响)，就能达到大约12%的瞬间年利率。

### Steem中的记账

STEEM供应量的增加主要是基于记账因素的，其目的是避免针对可流动STEEM收取负利率。 负利率会给交易所带来麻烦，其原因在于，交易所必须针对用户持有的STEEM的负利率而调整用户余额。 将区块链的逻辑原样照搬会容易出错，且将集成和采纳的过程复杂化。 因此，STEEM的选择就是，从不对用户账户收费，而是增加供应量。 由此就实现了类似的经济效果，而不用强迫每个人在内部账簿中接受STEEM存款来实现负利率。

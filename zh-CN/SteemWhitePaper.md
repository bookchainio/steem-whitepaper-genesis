...
这些百分比常数对分配和供给的整体影响是，(大约) 每分钟800个STEEM的速率会保持一定的时间 (例如：STEEM单位)，但按百分比（例如：随着整体供应量越来越大，800个STEEM所占的比例会越来越小）而言是下降的。 当每分钟800个STEEM的速率所涉及的各个组件都达到各自的基于百分比的下限时，相关的组件就会因此而停止下降。 反过来这意味这，从长远来看，STEEM的增长率会从每分钟800个STEEM，增长到 (受时间和网络供应影响) 相应的数值，以便能够维持年增长率为10%的贡献奖励，同时也维持年增长率为100%的贡献奖励和能量奖励的综合效果。 其综合效果就是STEEM的年供应量会翻倍 (但是，正如下一节所述，如果大多数用户会Power Up，这种翻倍的效果其实上是一种不转换所有权的“分割”)。

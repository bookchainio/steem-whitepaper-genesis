...
برخی اصول کلیدی جهت استفاده برای هدایت طراحی Steem وجود دارد. مهمترین اصل این است که هر کس که در سرمایه گذاری مشارکت کند باید سهم خودرا از مالکیت، پرداخت یا بدهی سرمایه گذاری دریافت کند. This principle is the same principle that is applied to all startups as they allocate shares at founding and during subsequent funding rounds.

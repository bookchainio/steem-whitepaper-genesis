...
Skupni učinek teh odstotnih konstant glede razdelitve in zaloge je ta, da stopnja (približno) 800 STEEM-ov na minuto ostane aktualna nekaj časa (z drugimi besedami enot STEEM-ov), vendar pade v odstotnem smislu (z drugimi besedami 800 STEEM-ov postane vse manjši in manjši delež skupne zaloge, ko skupna zaloga postaja vse večja). Kadar različne posamezne komponente te stopnje 800 STEEM-ov na minuto dosežejo vsaka svoje z odstotki pogojeno dno, vsako dno zaustavi padec svoje komponente stopnje. To pa nadalje pomeni, da bo dolgoročno nominalna stopnja narasla iz 800 STEEM-ov na minuto na (časovno nihajočo, od zaloge odvisno) vrednost, potrebno za to, da bi se ohranjala stalna 10% letna rast za nagrade prispevkov in stalna 100% letna rast za skupni učinek nagrad prispevkov in nagrad za moč. The overall effect is a doubling of the STEEM supply each year (but, as detailed in the next section, if most users Power Up then much of this doubling is effectively a "split" which does not transfer ownership).

...
Vzemimo, da je začetno razmerje rezerve 200x. Zaradi frakcijskih rezerv to pomeni, da ima nekdo, ki ima v lasti 1% žetonov, pravico zahtevati transakcije, ki skupaj znašajo 2x maksimalne velikosti bloka. In order to bring the network usage of the attacker down to 25% the reserve ratio would have to fall to 25x. This would cause the minimum balance required to transact once per week to grow by 8x.

...
Rešitev za težave z mikroplačili je v izvedbi *dinamičnih frakcijskih rezerv*. Pri tem modelu bo blockchain v obdobju prezasedenosti samodejno prilagajal razmerje rezerv za omrežje. The blockchain will set a target utilization that leaves enough headroom for short term surges in demand. Any time the surges are sustained the blockchain reduces the maximum bandwidth-per-share. When a surge is over and there is surplus capacity the blockchain can slowly increase the bandwidth-per-share.

...
Iz tega lahko sklenemo, da se blockchain najbolje izkoristi, če se sploh ne uporablja pristojbin. If a usage fee were to be charged as an alternative to rate limiting, then it should be the equivalent of buying enough timeshares and committing to hold them long enough to gain the right use it once.

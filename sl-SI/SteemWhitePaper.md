...
SP se lahko pretvori nazaj v STEEM v razdobju dveh let v 104 enakih tedenskih zneskih. Na "1 SP" se lahko gleda kot na delež v bazenu STEEM-a. Omrežje ob ustvaritvi vsakega bloka samodejno doda STEEM v bazen. At any time users can convert their STEEM into SP at the same ratio as STEEM in the vesting pool to total SP. Converting STEEM to SP does not dilute existing holders of SP. Likewise, every time SP is converted back to STEEM it is done at the current ratio. Individuals are guaranteed to have more STEEM in the future than they have when they rst convert from STEEM to SP.

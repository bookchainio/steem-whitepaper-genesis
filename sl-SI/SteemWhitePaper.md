...
Prenos iz STEEM-a v SP se imenuje Power Up (pridobitev moči), medtem ko se prenos iz SP-ja v STEEM imenuje Power Down (izguba moči). Na primer, posameznik lahko opravi Power Down svojega STEEM-a v razdobju dveh let, vendar pa lahko opravi Power Up STEEM-a v trenutku.
...
Vrednost, ki jo vsaka valuta doseže, je odvisna od povpraševanja po vplivu znotraj določene skupnosti in od prepričanja trga glede tega, kako obsežna lahko vsaka skupnost postane. Za razliko od prejšnjih sistemov subjektivno dokazilo o delu omogoča skupnosti, da kolektivno financira razvoj nečesa, kar se ji zdi dragoceno, in omogoča monetizacijo časa, kar prej ni bilo mogoče.
...
S to sliko v mislih lahko sklenemo, da bo sistem, ki temelji na pristojbinah, bodisi dražji za uporabnike bodisi manj donosen za skupne lastnike. Posamezni manjši lastnik lahko z izposojo svojega malega časovnega deleža ustvari dobiček, vendar zgolj na račun vseh drugih lastnikov. Pravzaprav strošek padajoče vrednosti časovnega zakupa občutijo vsi lastniki, medtem ko ima dobiček samo tisti posamezni lastnik, ki se odloči dati svoj delež v najem.
...
Odstotne omejitve učinkovito zagotavljajo, da nagrade čez čas ne postanejo nesmiselno majhne, namreč da sistem ne bi tako rekoč naletel na "ležečega policaja", kar je vzorec rasti mnogih drugih blockchainov, pri katerih nagli začetni rasti, podžgani z velikimi začetnimi nagradami za zgodnje udeležence, sledi dolgotrajna stagnacija, ko nagrade vztrajno padajo do te mere, da postanejo tako nizke, da novih udeležencev ne privabijo, da bi se pridružili.

Skupni rezultat teh odstotnih konstant glede razdelitve in zaloge je ta, da stopnja (približno) 800 STEEM-ov na minuto ostane aktualna nekaj časa, vendar pade v odstotnem smislu (z drugimi besedami 800 STEEM-ov postane vse manjši in manjši delež skupne zaloge, ko skupna zaloga postaja vse večja). Kadar različne posamezne komponente te stopnje 800 STEEM-ov na minuto dosežejo vsaka svoje z odstotki pogojeno dno, vsako dno zaustavi padec svoje komponente stopnje. To pa nadalje pomeni, da bo dolgoročno nominalna stopnja narasla iz 800 STEEM-ov na minuto na (časovno nihajočo, od zaloge odvisno) vrednost, potrebno za to, da bi se ohranjala stalna 10% letna rast za nagrade prispevkov in stalna 100% letna rast za skupni rezultat nagrad prispevkov in nagrad za moč. Skupni rezultat bo, da se bo vsako leto podvojila zaloga STEEM-a (vendar kot je podrobno opisano v naslednjem razdelku, če večina uporabnikov naredi Power Up, potem velik del te podvojitve pravzaprav pomeni "razdelitev" brez prenosa lastništva).

Skupna slika glede zaloge je zapletena zaradi učinka SMD operacij, ki lahko povzročijo obsežno ustvarjanje ali uničevanje STEEM-ov glede na stopnjo virov in SMD nagrade, kot je bilo obravnavano v razdelku glede SMD operacij. Obstajajo pa tudi drugi manj obsežni vplivi, med drugim neprevzete nagrade (na primer nagrade glede blokov za zgrešene bloke), šum zaradi rudarjeve sreče pri proizvajanju z dokazilom o delu in učinki sprememb pri dolžini rudarjeve vrste zaradi spremenjene moči razprševanja celotnega omrežja.

## Vpliv stopnje ustvarjanja žetonov

Na prvi pogled je 100% letno povečanje zaloge STEEM-a morda videti kakor hiperinflacija in kakor nekaj, kar ne more obstati. Tisti, ki spremljajo Kvantitativno teorijo denarja[^16] bi lahko celo sklenili, da mora vrednost STEEM-a pasti za približno 5,6% na mesec. Iz neštetih primerov iz resničnega sveta vemo, da količina denarja nima neposrednega in takojšnjega učinka na njegovo vrednost, čeprav to gotovo ima določen vpliv.

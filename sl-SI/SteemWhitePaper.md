...
Algoritem za rudarjenje, ki ga je sprejel Steem, zahteva od rudarjev, da imajo dostop do zasebnega ključa računa, ki bo prejemal nagrade. Ta zahteva ima več pomembnih posledic. Kot prvo, spodbuja optimizacijo algoritmov za preverjanje eliptičnega krivuljnega podpisa, ki ga potrebuje Steem. Second it makes it challenging to set up mining pools because the pool operator would have to share control over the reward with all of the "anonymous" miners. Third, it makes it difficult to use botnets because the botnet operator would have to distribute their private key to all compromised machines.

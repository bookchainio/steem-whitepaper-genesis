...
Steem is een blockchain databank dat het vormen van gemeenschappen en sociale interactie ondersteunt met cryptovaluta beloningen. Steem combineert concepten uit sociale media met lessen uit het bouwen van cryptovaluta en hun gemeenschappen. Een belangrijk onderdeel bij het inspireren van deelname in elke gemeenschap, valuta of vrije markteconomie is een eerlijk boekhoudkundig systeem dat de bijdrage van elke persoon consequent weerspiegelt. Steem is de eerste cryptovaluta die probeert om op nauwkeurige en transparante wijze een onbegrensd aantal personen te belonen die *subjectief bijdragen* aan de gemeenschap.
...
Vanaf augustus 2008 tot en met januari 2009 groeide de Amerikaanse geldhoeveelheid[^17] van $871 miljard naar $1737 miljard, een percentage van meer dan 100% per jaar en vervolgens bleef het de 6 opvolgende jaren groeien met ongeveer 20% per jaar. Alles bij elkaar is de geldhoeveelheid in de V.S. 4,59x gegroeid in minder dan 7 jaar. In diezelfde tijd is de waarde van de dollar ten opzichte van goederen en diensten minder dan 10% gedaald volgens de prijsindex van de overheid[^18]. Dit praktijkvoorbeeld toont aan dat het aanbod slechts één onderdeel is van de prijs.

De prijs van een digitaal product, zoals STEEM, wordt bepaald door zowel vraag als aanbod. Indien nieuwe STEEM wordt toegewezen aan degenen die het vasthouden op lange termijn, wordt de toename van het aanbod gecompenseerd door de overeenkomstige vraag naar het vasthouden. De impact van deze verandering in het aanbod wordt uitgesteld tot een toekomstige datum waarop de langetermijnhouder besluit te verkopen. De verkoopdruk wordt dan verdeeld over 2 jaar.

Wanneer een langetermijnhouder besluit de markt te verlaten, zal het aanbod van STEEM toenemen en de prijs omlaag duwen. Deze neerwaartse druk wordt tegengegaan wanneer een nieuwe langetermijnhouder besluit de STEEM op te kopen en weer om te zetten naar SP. We kunnen dan ook concluderen dat de prijs vooral zal worden beïnvloed door een verandering in de vraag naar het vasthouden van STEEM op lange termijn.

Van de 100% jaarlijkse toename van het virtuele STEEM-aanbod is 5% in de vorm van Steem Dollars (SMD). SMD representeert een streven om een dollar aan waarde van STEEM te creëren en heeft geen invloed op de hoeveelheid STEEM op de markt vandaag. De verandering in de verhouding schuld-naar-eigenaarschap kan van invloed zijn op de waargenomen waarde van STEEM, maar heeft geen directe val van de waarde van STEEM tot gevolg. Als de waarde van Steem in de loop van de tijd stijgt, dan zal de hoeveelheid STEEM die in de toekomst gecreëerd kan worden minder zijn en zal de overeenkomstige "inflatie" nooit echt gebeuren.

Alles bij elkaar bedragen de totale "uitgaven" die Steem doet om inhoud, curatie, mining en blokproductie te financieren minder dan 10% APR of 1.2% per maand. The same wealth transfer could be implemented without any change in the STEEM supply by implementing a negative interest rate on liquid STEEM of around 10% per month. Stated another way, it could be implemented by charging a 3% fee (similar to credit cards) on every transfer and having 1% of all STEEM transferred every single day. The Bitcoin network transfers[^19] 400,000 BTC out of 15.5M (or 2.5% daily).

...
La stabilità è una caratteristica importante nelle economie globali di successo. Senza stabilità, le persone nel mondo non potrebbero avere costi cognitivi bassi mentre stanno cercando di risparmiare o di fare commercio. Perché la stabilità è una caratteristica importante delle economie globali di successo, gli Steem Dollars sono stati progettati per portare stabilità nel mondo delle criptovalute ed alle persone che usano la rete di Steem.

Gli Steem Dollars sono creati con un meccanismo simile a quello delle banconote scambiabili, che sono di solito usate nelle start up. Nel mondo delle start up, le banconote di scambio sono obbligazioni a breve termine che possono essere convertite in patrimoni ad un ratio determinato nel futuro, tipicamente durante un prossimo giro di finanziamento. Un token basato sulla blockchain può essere visto come una proprietà della comunità mentre una banconota di scambio può essere vista come un debito espresso in qualsiasi valuta o comodità. I termini delle banconote di scambio permettono al proprietario di convertire al token di protezione con un minimo preavviso al prezzo del token di mercato giusto. Creando token convertibili in dollari permette alla blockchain di crescere la sua rete e ai proprietari di tokens di aumentare il loro profitto.

Gli Steem Dollars sono anche riferibili col simbolo SMD, un acronimo per Steem Dollars. Creare SMD richiede una combinazione di un prezzo affidabile, regole per prevenire l'abuso e liquidità. Dando un prezzo affidabile richiede 3 fattori: la minimizzazione dell'impatto di un feed errato, massimizzare i costi del produrre un feed errato e minimizzare l'importanza della tempistica.

### Minimizzare feed fraudolenti

I proprietari di SP eleggono persone per pubblicare i prezzi dei feed. Queste persone elette sono presumibilmente attendibili da quelli che hanno portato interesse nella qualità nel feed. Pagando quelli che sono stati eletti, Steem crea una competizione di mercato per guadagnare i feed di procedura giusti. Più i produttori di feed sono pagati più devono essere puniti per pubblicare informazioni false.

...
Ci sono due modi con i quali le persone possono venire coinvolte in una comunità di criptovalute: loro possono *comprarle* o possono *lavorarci*. In entrambi i casi, gli utenti stanno apportando valore alla valuta, anche se, la grande maggioranza delle persone ha più *tempo libero* di quanto *denaro risparmino*. Immaginare di raggiungere un obbiettivo tramite una valuta in una comunità povera non avente in origine il denaro ma un buon quantitativo di tempo le persone possono guadagnare soldi lavorando l'uno per l'altro, quindi guadagneranno valore attraverso scambi reciproci facilitati da un sistema di contabilità / moneta equo.

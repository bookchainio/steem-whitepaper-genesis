...
Questo processo è progettato per fornire la migliore affidabilità mentre viene garantito che tutti hanno il potenziale di partecipare nella produzione di blocchi, indipendentemente dal fatto che siano popolari abbastanza da essere votati al massimo. Persone sono disponibili tre opzioni per superare la censura dai top 19 testimoni eletti: pazientemente attendere in linea con tutti gli altri non nella top 19, acquisto computazionale abbastanza potere per risolvere una prova di lavoro più velocemente di altri, o acquistare più SP per migliorare il potere di voto. Parlando in generale, ricorrere alla censura è un buon modo per i testimoni eletti di perdere il loro lavoro, pertanto, è improbabile che si tratti di un problema reale nella rete di Steem.

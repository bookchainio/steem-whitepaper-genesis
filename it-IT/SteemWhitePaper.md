...
Gli Steem Dollars sono creati con un meccanismo simile a quello delle banconote scambiabili, che sono di solito usate nelle start up. Nel mondo delle start up, le banconote di scambio sono obbligazioni a breve termine che possono essere convertite in patrimoni ad un ratio determinato nel futuro, tipicamente durante un prossimo giro di finanziamento. A blockchain based token can be viewed as ownership in the community whereas a convertible note can be viewed as a debt denominated in any other commodity or currency. The terms of the convertible note allow the holder to convert to the backing token with a minimum notice at the fair market price of the token. Creating token-convertible-dollars enables blockchains to grow their network effect while maximizing the return for token holders.

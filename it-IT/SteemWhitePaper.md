...
Se un token viene visto come una proprietà in tutta la fornitura di tokens, un token convertibile in dollaro può essere visto come un debito. Se il rapporto tra debito e proprietà diventa troppo alto l'intera valuta può diventare instabile. La conversione del debito può far aumentare notevolmente la fornitura di token, che a loro volta viene venduta sul mercato uccidendo il prezzo. Le successive conversioni richiedono l'emissione di ancora più token. Se il sistema non viene controllato esso può crollare lasciando proprietà senza valore che coprono una montagna di debiti. Più il rapporto tra debito e proprietà è alto gli investitori saranno più sfiduciati a portare il loro capitale sul tavolo.

Per ogni SMD che Steem crea, vengono creati $19.00 di STEEM che vengono poi convertiti in SP. Questo significa che il più alt rapporto tra debito e proprietà in un mercato stabile è 1:19 o più o meno 5%. Se Seem cade in valore di 50% il rapporto potrebbe aumentare al 10%. Una caduta dell'88% nel valore di STEEM potrebbe causare il rapporto tra debito e proprietà al 40%. Assumendo che il valore di STEEM si stabilizzi, il rapporto tra debito e proprietà si stabilizzerà naturalmente vicino al 5%.

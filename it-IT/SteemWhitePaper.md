...
Ci sono due modi con i quali le persone possono venire coinvolte in una comunità di criptovalute: loro possono *comprarle* o possono *lavorarci*. In entrambi i casi gli utenti stanno aggiungendo valore alla valuta, tuttavia, la maggioranza delle persone ha più tempo di quanto denaro possa investire Immaginare di raggiungere un obbiettivo tramite una valuta in una comunità povera non avente in origine il denaro ma un buon quantitativo di tempo le persone possono guadagnare soldi lavorando l'uno per l'altro, quindi guadagneranno valore attraverso scambi reciproci facilitati da un sistema di contabilità / moneta equo.

La distribuzione di una valuta a quante più persone possibile in un modo che viene generalmente percepito come equo è una sfida impegnativa. Le attività che possono essere interamente valutate oggettivamente da un algoritmo di un computer sono limitate per natura e in generale hanno limitato i benefici esterni positivi. Nel caso del mining in stile Bitcoin, può portare alla produzione di hardware specializzati e indurre le persone a investire tempo nello sviluppo di algoritmi più efficienti.   Essa può anche aiutare a trovare numeri primi, ma nessuna di queste cose fornisce valore significativo alla società o in generale alla valuta detenuta dalla comunità. Ancora più importante, le economie di scala e le forze di mercato finiranno per escludere tutti, tranne gli esperti, dalla partecipazione a questo tipo di distribuzione. Ultimately, computation-based mining is just another way of *buying* in because it requires money to pay the electric bill or the development of hardware necessary to do the work.

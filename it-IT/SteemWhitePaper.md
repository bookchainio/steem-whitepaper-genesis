...
Lo steem sta costantemente incrementando la sua offerta annua del 100% a causa di incentivi non SMD Qualcuno che detiene STEEM senza convertirli in SP, subisce una diluizione di circa 0.19% al giorno. Anche se il tasso può sembrare elevato per transazioni che richiedono meno di 10 giorni, è comunque meno costoso dei tassi d'interesse operati dalle carte di credito. Inoltre, la creazione giornaliera di token è irrilevante rispetto alla volatilità giornaliera.

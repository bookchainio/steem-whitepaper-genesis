...
Piattaforme già esistenti operano un principio di un-utente, un-voto. Questo crea un ambiente dove le classifiche possono essere manipulate da attacchi sybil ed i fornitori dei servizi devono identificare e bloccare i danneggiatori. Persone hanno già tentato di manipulare Reddit, Facebook e Twitter ottenendo algoritmu quando l'unico premio è il traffico web o la censura.

L'unità fondamentale di contabilità sulla piattaforma Steem è STEEM, un token di criptovaluta. Steem opera sulla base di uno-STEEM, un voto. Usando questo modello persone che hanno contribuito di più sulla piattaforma, venendo misurati sul loro conto dell'account, hanno un influenza maggiore su come calcolare i contributi. Inoltre, Steem concede solo a membri di votare con STEEM quando è impegnato in un programma di investimento pluriennale. Usando questo modello, i membri hanno un incentivo finanziario per votare in un modo che massimizzi il valore futuro dei loro STEEM.

Steem è progettato attorno ad un concetto abbastanza semplice: *ogni contributo significativo alla comunità dovrebbe essere riconosciuto per il suo valore aggiunto.* Quando le persone sono riconosciuto per i loro contributi significativi, continuano a contribuire e la comunità cresce. Qualunque squilibrio nel dare e nel prendere dentro ad una comunità è insostenibile. Alla fine i donatori saranno stanchi di supportare i ricevitori e si distaccheranno dalla comunità.
...
Un sistema già in uso per valutare e premiare le contribuzioni è il mercato libero. Il mercato libero può essere visto come una comunità singola dove ognuno tratta con altri ed i premi sono assegnati dai guadagni e dalle perdite. Il sistema del mercato premia quelli che forniscono valore ad altri e punisce quelli che consumano più valore di quanto ne creano. Il mercato libero supporta molte valute diverse ed il denaro è solo una comodità che ognuno trova facile da scambiare.

Dato che il mercato libero è un sistema collaudato, garba l'idea di creare un sistema di mercato libero dove i consumatori che sfruttano i contenuti paghino i produttori stessi. Comunque il pagamento è inefficiente e non molto affidabile per la creazione e cura di contenuti. Il valore della maggior parte dei contenuti è basso rispetto ai costi cognitivi e finanziari accompagnati dai pagamenti che pochi lettori scelgono di effettuare. L'abbondanza di alternative vuol dire che forzare un "paywall" manderebbe lettori altrove. Ci sono stati diversi esperimenti per implementare un micropagamento per-articolo dai lettori agli autori, però nessuno è diventato virale.

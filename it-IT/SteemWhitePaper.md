...
Per ogni SMD che Steem crea, vengono creati $19.00 di STEEM che vengono poi convertiti in SP. Questo significa che il più alt rapporto tra debito e proprietà in un mercato stabile è 1:19 o più o meno 5%. If Steem falls in value by 50% then the ratio could increase to 10%. An 88% fall in value of STEEM could cause the debt-to-ownership ratio to reach 40%. Assuming the value of STEEM eventually stabilizes, the debt-to-ownership ratio will naturally move back toward 5%.

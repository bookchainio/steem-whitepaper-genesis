...
In modo da dare a tutti un' equa opportunità di mettersi in gioco e di guadagnare valuta le persone devono donare una opportunità di lavorare La sfida è come giudicare la qualità relativa e la quantità di lavoro che forniscono gli individui e per farlo in un modo che alloca in modo efficiente ricompense a milioni di utenti. Ciò richiede l'introduzione di un processo di voto scalabile. In particolare necessita che le autorità preposte ad allocare i fondi devano il più possibile essere distribuite e decentralizzate 

Il primo passo per premiare milioni di utenti è quello di impegnarsi a distribuire una quantità fissa di valuta indipendentemente da quanto lavoro è effettivamente fatto o da come gli utenti votano. Ciò cambia la domanda dall'essere * "Dovremmo pagare?" </ 0> a * "Chi dovremmo pagare?" </ 0> e segnali al mercato che il denaro viene distribuito e viene venduto all'asta per chiunque "fa un'offerta" il più * funziona </ 0>. Questo è simile al Bitcoin che si impegna ad assegnare 50 BTC a chi trova gli hash più difficili. Come Bitcoin, tutto il lavoro deve essere fatto prima del pagamento e nulla dovrebbe essere pagato in modo speculativo sulla promessa di lavorare in futuro.</p> 

...
Per fare in modo di riallineare gli incentivi e dissuadere le persone semplicemente dal votare per loro stesse, il denaro deve essere distribuito in una maniera non lineare. Per esempio, una funziona quadrata di voti, cioè, qualcuno avente il doppio dei voti di qualcun altro, dovrebbe ricevere quattro volte il pagamento e, qualcuno avente un totale di voti pari a tre, dovrebbe ricevere nove volte il pagamento. In altre parole, la ricompensa è proporzionale ai \\(votes^{2}\\), piuttosto che ai voti (non elevati alla seconda). This mirrors the value of network effect which grows with \\(n^{2}\\) the number of participants, according to Metcalfe's Law[^5].

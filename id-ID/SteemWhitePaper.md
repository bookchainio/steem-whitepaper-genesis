...
Unit fundamental dari akun pada platform Steem adalah STEEM, sebuah token mata uang kripto. Steem beroperasi berdasarkan pada satu-STEEM, satu suara. Dengan model seperti ini, individu yang telah memberikan kontribusi terbanyak kepada platform, diukur dengan saldo akun mereka, berpengaruh paling besar mengenai bagaimana kontribusi diberikan. Furthermore, Steem only allows members to vote with STEEM when it is committed to a multi-year vesting schedule. Under this model, members have a financial incentive to vote in a way that maximises the long term value of their STEEM.

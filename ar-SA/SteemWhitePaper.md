...
## منصة تواصل إجتماعي تحفيزية، قائمة على سلسة الكتل.
...
ستيم هو عبارة عن قاعدة بيانات قائمة على سلسلة الكتل التي تقوم بدعم المجتمع وبناء لمختلف التفاعلات الإجتماعية مع وجود مكافآت على شكل عملات رقمية. يقوم ستيم بدمج العديد من المفاهيم الخاصة بوسائل التواصل الإجتماعي، إلى جانب الإعتماد على العديد من الدروس المستقاة من عمليات بناء العملات المعماة والمجتمعات الخاصة بها. مفتاح مهم لإلهام المشاركة في أي مجتمع، العملة أو إقتصاد السوق الحر هو نظام المحاسبة العادلة التي تعكس باستمرار مساهمة كل فرد. ستيم هي العملة الرقمية الأولى التي تحاول بدقة و شفافية مكافأة عدد غير محدود من الأفراد الذين شاركوا *مساهمات ذاتية* لمجتمعاتها.
...
و بما أن السوق الحر نظام أثبت قدراته، فإنه سيكون من المغري أن يتم إنشاء سوق حرة أين يقوم المستهلكين بالدفع للمنتجين بكشل مباشر. و مع ذلك، فإن الدفع المباشر يعد غير فعال ولا يمكن الإعتماد عليه لإنشاء المحتوى وتمويله. حيث أن قيمة معظم المحتوى منخفضة جدا بالنسبة إلى المعرفية، و المالية، و التكاليف المناسبة مرتبطة بإجراء الدفع و التي يختارون تلميحها القلة القليلة من القراء. توفر البدائل المجانية يعني أن فرض "paywall"  سيدفع القراء إلى أماكن أخرى. كانت هناك عدة محاولات لتنفيذ المدفوعات الصغيرة لكل مقال من القراء إلى المؤلفين، ولكن لم يُنشر أي منها على نطاق واسع.
...
غالبية التضخم هو في الواقع أداة محاسبة بدلاً من إعادة توزيع حقيقية للثروة. 90% من التضخم خارج نطاق دولارات ستيم (non-SMD) يتم إعادته وتوزيعه لحاملي ستيم (STEEM) الحاليين بما يتناسب مع قيمة طاقة الستيم الموجودة في أرصدتهم إذا قمنا بتقييمها وفقا للستيم. الأمر الذي سيجعل التضخم يبدو وكأنه إنقسام. فقط حوالي 10 ٪ من التضخم الخارج عن نطاق دولارات ستيم (non-SMD) يعيد توزيع الملكية في الشبكة.
...
يمكن تحويل طاقة ستيم (SP) مرة أخرى إلى STEEM خلال عامين عبر 104 دفعة أسبوعية متساوية. يمكن اعتبار 1 طاقة ستيم (1 SP) بمثابة حصة في إحدى مُجَمَّعات(pool) ستيم (STEEM). الشبكة تضيف ستيم (STEEM) تلقائيا إلى المُجَمَّع(pool) عند كل كتلة. يمكن للمستخدمين تحويل ستيم (STEEM) إلى طاقة ستيم (SP) في أي وقت بنفس نسبة ستيم في مُجَمَّع المستحقات (vesting) بالنسبة لإجمالي طاقة ستيم. تحويل ستيم (STEEM) إلى طاقة ستيم (SP) لا يؤدي إلى إضعاف حاملي طاقة ستيم (SP) الحاليين. وبالمثل، في كل مرة يتم إعادة تحويل طاقة ستيم إلى ستيم، فإن ذلك يتم وفقا للنسب الحالية. ويضمن للأفراد الحصول على المزيد من STEEM في المستقبل أكثر مما كان لديهم عند تحويلهم STEEM إلى SP لأول مرة.
...
تسمى عملية تحويل الستيم(STEEM) إلى طاقة الستيم(SP) بعملية رفع/تحويل الطاقة(powering up)، بينما يشار إلى عملية تحويل طاقة الستيم إلى الستيم بتخفيض الطاقة(powering down). على سبيل المثال، يمكن للمرء أن يقلل/يحول (power down) طاقة ستيم الخاصة به خلال فترة سنتين، بينما يمكن رفع الطاقة (power up) على الفور.

## ستيم دولار (SMD)

الاستقرار سمة هامة من سمات الإقتصادات العالمية الناجحة. وبدون الإستقرار، لا يمكن للأفراد في جميع أنحاء العالم أن يكون لديهم تكاليف إدراكية منخفضة أثناء الإنخراط في التجارة والمدخرات. لأن الإستقرار هو سمة هامة من سمات الإقتصادات الناجحة، تم تصميم ستيم دولار كمحاولة لتحقيق الإستقرار في عالم العملات الرقمية وللأفراد الذين يستخدمون شبكة ستيم.
...
وتعتمد القيمة التي تحققها كل عملة على الطلب على التأثير داخل مجتمع معين وعلى مقدار ما تعتقد السوق أنه يمكن لكل مجتمع الحصول عليه. على عكس الأنظمة السابقة، فإن إثبات العمل الشخصي يمكّن المجتمع من تمويل تطوير كل ما يراه قيماً ويمكّن تحقيق الدخل من وقت لم يكن يمكن تحقيق الدخل منه سابقًا.
...
> #### قصة دلو السرطان [^6]
> 
> كان هناك رجل يتمشى على طول الشاطئ ورأى رجلً آخر يصطاد في الأمواج مع دلوِ طُعمٍ بجانبه. وعندما اقترب أكثر رأى أن دلوَ الطُعمِ لا يملك غطاءً وأن هناك سلطعونات حية في داخله.
> 
...
القضاء على "سوء المعاملة" ليس ممكنا ولا ينبغي أن يكون الهدف. وحتى أولئك الذين يحاولون "إساءة استخدام" النظام فهم لا يزالون يعملون. أي تعويض يحصلون عليه لمحاولاتهم الناجحة في إساءة استخدام النظام أو التواطؤ هو على الأقل ذو قيمة من أجل توزيع العملة كنظام العمل الذي يستخدمه تعدين البيتكوين (Bitcoin) التقليدي أو التعدين الجماعي الذي تقوم به مُجَمَّعات(Pool) التعدين. كل ما هو ضروري هو التأكد من أن إساءة الاستخدام ليست متفشية بحيث تقضي تدريجيا على الحافز للقيام بعمل حقيقي لدعم المجتمع وعملته.
...
مناقشة جيدة تتطلب النشر ذهابًا وإيابًا. عند الرد على شخص آخر، يحصلون على 50٪ من أي دفعات ستتلقاها في ذاك الموضوع. تنطبق هذه القاعدة على 6 طبقات كحد أقصى من العمق. بدء نقاش كبير يكافئ بشكل كبير الناشر الرئيسي.

الفشل في تهيئة مشاركاتك بشكل مناسب في المناقشة هي طريقة جيدة لتحصل على تصويت سالب.
...
عندما يتلقى المنشور الدفعات، فهي تأخذ شكل 50% طاقة ستيم (SP) و 50% دولارات ستيم (SMD). طاقة ستيم (Steem Power) تعطي المستخدم زيادة في التصويت وقوة للمعاملات في حين أن دولارات ستيم (SMD) تعطي المستخدم فائدة فورية على شكل عملة مستقرة. كما سبق أن ناقشنا بشكل مطول، تم تصميم طاقة ستيم (SP) لتشجيع الإمتلاك على المدى الطويل بدلا من البيع على المدى القصير.
...
من الناحية النظرية، تشبه خوارزمية الإجماع التي اعتمدتها ستيم (Steem) خوارزمية الإجماع التي تتبناها الشركات في جميع أنحاء العالم. فالأشخاص الذي لديهم مصلحة في القيمة المستقبلية لستيم (Steem)، سيصوتون على الأفراد المسؤولين عن إدراج الشهادة في السجل العام. ذلك أن وزن التصويت يتم دائما حسابه بما يتناسب مع حجم إستثمار ومصالح (vested interest) كل فرد.

في عالم العملات المشفرة، يشار إلى السجل العام عادة باسم *سلسلة الكتل*، *الكتلة* هي مجموعة من المعاملات الموقعة.

مع ستيم (Steem)، يتم إنتاج الكتل في جولات. يتم اختيار 21 شاهد في كل دورة لإنشاء وتوقيع كتل من المعاملات. يتم اختيار تسعة عشر (19) من هؤلاء الشهود عبر إستعمال ما يسمى بالموافقة أو التصويت المتعدد (Approval voting)، ويتم إختيار واحد آخر من خلال إثبات العمل الحاسوبي، وأخر يتم تقاسمه مع الوقت بما يتناسب مع مجموع أصوات الشهود الذين لم يصلوا إلى القائمة الأولية التي تحتوي على 19 شاهد. ويتم خلط الشهود النشطين البالغ عددهم 21 شاهدا في كل جولة لمنع أي شاهد من تجاهل الكتل التي ينتجها الشاهد نفسه الموضوع من قبل.
...
نظرًا لأن الشهود النشطين معروفون مسبقًا، فإن ستيم (Steem) قادرة على جدولة الشهود لإنتاج الكتل كل 3 ثوانٍ. الشهود يزامنون انتاج كتلهم عبر بروتوكول وقت الشبكة (NTP). تم استخدام متغير من هذه الخوارزمية بواسطة شبكة BitShares لأكثر من سنة، وقد ثبت أنه نظام موثوق ويمكن الإعتماد عليه.

## التعدين في ستيم (Steem)

يعمل النموذج التقليدي لسلسلة الكتل عبر الجمع بين إنتاج الكتل، وحلول إثبات العمل. نظرًا لأن عملية حل إثبات العمل تستغرق وقتًا غير متوقع، فإن النتيجة هي أوقات إنتاج كتل غير متوقعة. تهدف ستيم (Steem) إلى إنتاج كتلة متناسقة وموثوقة كل 3 ثوان مع عدم وجود إمكانية للتفرع (إستنساخ).

لتحقيق هذا تفصل ستيم (Steem) إنتاج الكتل عن حل إثبات العمل. عندما يحل معدن ما إثبات عمل لستيم (Steem)، فإنه يبث معاملة تحتوي على العمل. الشاهد المجدول التالي، يدرج المعاملة في سلسلة الكتل (blockchain). عندما يتم تضمين المعاملة يتم إضافة المُعدن إلى قائمة انتظار المعدنين المقرر أن ينتجوا الكتل. في كل جولة ينقل معدن من قائمة الانتظار ويدرج ضمن مجموعة الشهود النشيطين. يتم الدفع للمعدن عندما ينتج كتلة في الوقت المحدد لها.
...
بعد الشهر الأول، يتم الدفع لمعدني ستيم عبر (SP). تصبح طاقة ستيم متاحة للتداول عبر تحويلها لستيم في عملية تستغرق سنتين. وهذا يعني أن المعدنين يجب أن ينتظروا لفترة طويلة، على الأرجح عدة أشهر، قبل أن يتم تحويل مكافآت التعدين الكافية للسماح لهم باسترداد تكلفة الكهرباء والموارد الحاسوبية. إن عملية التحويل لا تشجع إنشاء مُجَمَّعات(pool) التعدين، لأن مشغل المُجمع(pool) يجب أن يوزع المدفوعات على مدار سنوات.

إن لعملية دفع مكافآت التعدين على شكل قوة الستيم (SP) دور وأثر مباشر في منع المُعدنين الحاليين من إستعمال الأسعار اليومية الآنية لتحديد مدى ربحية عملية التعدين. قليل من الأشخاص سيتفقون على ما سيكون عليه السعر المستقبلي. وهذا يعني أن الصعوبة في التعدين ستكون مدفوعة من قبل أولئك الذين يضعون أعلى تقدير للقيمة المستقبلية. المعدنين الذي لا توجد لديهم مصلحة طويلة المدى على المنصة، لن يتم تشجيهم أو سيفقدون الرغبة في المنافسة. وهذا يعني في نهاية المطاف، أن هناك احتمالية صغيرة للتخلّص من عائدات التعدين في السوق، لأنها ستعود إلى من لديهم تطلعات طويلة المدى في المنصة.

### خوارزمية التعدين

تتطلب خوارزمية التعدين التي اعتمدتها ستيم (Steem) أن يكون لدى المعدن حق الوصول إلى المفتاح الخاص للحساب الذي سيحصل على المكافآت. هذا الشرط له عدة عواقب مهمة. أولا، أنها تشجع على تحسين خوارزمية التحقق من المنحنى الإهليلجي(Elliptic curve) التي تحتاجها ستيم (Steem). ثانياً، أنها تجعل من الصعب إنشاء مُجَمَّع(Pool) التعدين لأن مشغل المُجَمَع التعديني يجب أن يتشارك السيطرة على المكافآت مع جميع المعدنين "المجهولين". ثالثًا، إنها تجعل استخدام شبكات البوتات (botnets) أمرًا صعبًا للغاية، والسبب هو أن مشغلي شبكات البوت (botnet) يجب أن ينشروا مفاتيحهم الخاصة عبر جميع الأجهزة المخترقة.

تصف الشفرة التالية كيفية حساب قيمة تجزئة(hash) إثبات العمل:
...
### مقاومة مُجَمَّع(Pool) عملية التعدين

لدى المعدن ثلاث ثوانٍ للحصول على كتلة، وحل إثبات العمل، وإرسال المعاملة إلى منتج الكتل التالي. تشتمل هذه الثواني الثلاث على وقت استجابة الشبكة، لذا من المهم جدًا أن يحافظ المعدنون على اتصال جيد بالشبكة للحصول على أقصى استفادة من موارد الحوسبة.

نظرًا لتغير الكتلة الرئيسية ووقت استجابة الشبكة باستمرار، فإن إعادة توجيه قالب لتعدين كتلة محددة للمشاركين في مُجَمَع(Pool) التعدين سيزيد من وقت استجابة الشبكة، ويقلل من كفاءة مُجَمَع التعدين بشكل كبير.

# إلغاء رسوم المعاملات

تبذل ستيم (Steem) جهذاً كبيراً لمكافأة الأشخاص الذين يساهمون في الشبكة. إذا تم فرض رسوم على الأشخاص في كل مرة يتفاعلون فيها مع المجتمع، سيؤدي ذلك إلى نتائج عكسية.

تعتمد تقنية سلسلة الكتل (Blockchain) حاليا على رسوم المعاملات لمنع السخام(spam). هذه الرسوم تعاني من جميع المشاكل المعروفة في المعاملات المصغرة وتمنع استخدام سلاسل الكتل (blockchains) في المعاملات ذات القيمة المنخفضة. في الحقيقة يجب أن تقدم التطبيقات اللامركزية للمستخدمين مظهر المعاملات المجانية إذا كانت ترغب في التنافس مع التطبيقات البديلة المركزية. توضح هذه الورقة النهج الذي إستخدمته ستيم (Steem) للقضاء على الحاجة إلى الرسوم، وبالتالي تمكين مجموعة واسعة من التطبيقات اللامركزية التي لم تكن منيعة سابقاً.

## مشكلة الرسوم

سلاسل الكتل (Blockchains) هي شبكات لامركزية حيث يتم بث جميع المعاملات لجميع الأقران. بين الحين والآخر يتم إنتاج كتلة تتضمن بعض أو كل المعاملات قيد الانتظار. يجب على كافة سلاسل الكتل (blockchains) العثور على حل لمنع المستخدمين الضارين من استهلاك كافة سعة الشبكة المتوفرة عبر المعاملات التي لا قيمة لها. يمكن لهذه المعاملات التي لا قيمة لها أن تمنع المعاملات القيّمة الأخرى من أن يتم معالجتها وفي النهاية تدمر الشبكة.

الحل الذي اعتمدته معضم سلاسل الكتل (blockchains) حتى الآن هو فرض ووضع حد أدنى للرسوم الخاصة بالتعاملات. تكفي رسوم بقيمة بضعة سنتات فقط لجعل الهجوم على الشبكة مكلفًا وغير مربح. في حين أن هذا النهج يحل مشكلة السخام(spam)، فإنه يقدم مشاكل جديدة في المقابل. تخيل حل مشكلة السخام من خلال فرض رسوم رمزية على كل بريد إلكتروني: لن يستخدم عندها الأشخاص البريد الإلكتروني.
...
> لا يمكن أن تكون المعاملة ذات قيمة كبيرة لدرجة أنها تتطلب إتخاذ قرار، أو أن تكون ذات قيمة صغيرة جداً بحيث يكون هذا القرار تلقائياً. فأية عملية إتخاذ القرار التي لها علاقة بشراء أي شيء مهما بلغ ثمنه أو صغره، سيكتنفها نوع من القلق والشكوك. إذا أن هذا القلق والتحفظ لا ينبع من الواجهة المستخدمة أو الوقت المطلوب لإتخاذ هذا القرار، ولكن جوهر الأمر يتعلق في الحقيقة بعملية إتخاذ القرار نفسها.  
> إن عمليات الدفع المصغرة مثلها مثل بقية عمليات الدفع، ستتطلب مقارنة: "هل هذا القدر من X يساوي هذا القدر من Y ؟" هناك حد أدنى لتكلفة المعاملات العقلية(mental transaction cost) الناتجة عن هذه الحقيقة التي لا يمكن تحسينها، لأن المعاملة الوحيدة التي سيكون المستخدم على استعداد للموافقة عليها بدون أي تفكير، هي تلك التي لا تكلفهم شيئًا، أي كأنها ليست معاملة على الإطلاق.
> 
> *- Clay Shirky[^8]*

في عالم المدفوعات المالية، تكون الرسوم الصغيرة مقبولة نظرًا لأن قيمة المعاملة مرتفعة للغاية بالنسبة إلى الرسوم المفروضة، وقد اتخذ المشتري بالفعل قرارًا بالشراء. إن عالم تطبيقات سلسلة الكتل المحتملة يعد أكبر بكثير من مجرد المدفوعات المالية، إذا أنه يتضمن أيضا العديد من المعاملات الضرورية التي ينظر إليها على أنها رسوم غير مقبولة من قبل للمسخدمين.

تسمح أنظمة مثل BitShares و Nxt و Ripple و Counter Party و Stellar للمستخدمين بوضع طلبات محددة على سلسلة الكتل (blockchain)، وجميعهم يفرضون رسوم صغيرة لتنفيذ هذا الإجراء. إذا رغب المستخدم في وقت لاحق إلغاء الطلب، يتم فرض رسوم أخرى. الأنظمة مثل إثريوم (Ethereum) تأخذ الدفعات المصغرة إلى مستوى جديد كليا: فرض رسوم على كل عملية حسابية. كل هذه الأنظمة تكافح من أجل جذب مستخدمين جدد للأسباب نفسها التي ستجعل محرك بحث لامركزي، يكافح لجذب المستخدمين من غوغل إذا فرض رسومًا بسيطة مقابل كل عملية بحث. لا يهم مدى جودة الخدمة، الناس يتوقعون أن تكون أشياء معينة مجانية. وهذا صحيح حتى إذا كان المستخدم سينتهي بدفع قيمة أكبر في إطار هيكل رسوم مختلف.

### الرسوم هي حواجز تحول دون دخول المستخدمين الجدد

جميع الرسوم تخلق حواجز لدخول المستخدمين الجدد. قبل أن يتمكن أي شخص من تجربة إيثريوم (Ethereum)، يجب عليه الحصول على بعض عملات إيثريوم أولاً (ETH). يجب على أي شخص يرغب في بناء تطبيق لامركزي على إيثريوم (Ethereum) أن يقوم بتحويل التكلفة إلى عملائه. إن شراء عملة مشفرة ليس مهمة سهلة ونادراً ما يكون الأمر منطقياً عندما يتم شراء عملات بمبالغ تقل عن 10 دولارات. ويعني هذا أنه يجب أولاً إقناع المستخدمين الجدد الراغبين في تجربة تطبيق لامركزي جديد بالتنازل عن مبلغ 10 دولارات.
...
في النظام اللامركزي، لا توجد طريقة مباشرة لحظر المستخدمين أو أن المزود المركزي قادرا على استضافة الكابتشا (reCAPTCHA) وفرض معدل الحد من الحسابات. في الواقع، عدم القدرة على فرض الرقابة على المستخدمين هي واحدة من نقاط البيع الرئيسية لتكنولوجيا سلسلة الكتل (blockchain).

### الإحتياطي الكامل ضد الإحتياطي الجزئي

دعونا ننظر إلى سلسلة الكتل (blockchain) وكأنها موزع لخدمة الإنترنت (ISP) والتي تملتك جميع كَبْلات البلدة، وتلك الكَبْلات لديها عرض نطاق ترددي أقصى يمكن أن توفره في أي وقت. ويمكن للناس الذين يعيشون في تلك البلدة من شراء أسهم في موزع خدمة الإنترنت (ISP)، وفي المقابل يحق لهم الاستفادة من جزء من عرض النطاق الترددي المتوفر لدى موزع الخدمة.
...
إن الحل لمشاكل الدفعات المصغرة هو في تنفيذ *احتياطات الكسور الديناميكية*. وبموجب هذا النموذج، تقوم سلسلة الكتل (blockchain) تلقائيًا بضبط نسبة الإحتياطي للشبكة أثناء أوقات الإزدحام. سوف تحدد سلسلة الكتل (blockchain) معدل العمل المتاح الذي سيترك مساحة كافية للزيادات في الطلب على المدى القصير. في الوقت الذي يتم فيه الحفاظ على معدل ثابت للزيادات، تقلل سلسلة الكتل (blockchain) من الحد الأقصى لعرض النطاق الترددي لكل سهم. عندما تنتهي الزيادة ويكون هناك فائض يمكن لسلسلة الكتل (blockchain) أن تزيد ببطء عرض النطاق الترددي لكل سهم.
...
لنقل أن B تساوي متوسط عرض النطاق الترددي للمستخدم في الوقت T. و W تساوي عدد الثواني في الأسبوع، و N تساوي حجم المعاملة الجديدة التي حدثت بعد S ثانية من T. في ضوء هذه المعلومات، يمكن لسلسلة الكتل (blockchain) أن تقوم بحساب متوسط النطاق الترددي الجديد للمستخدم على النحو التالي:
...
لفهم كيفية عمل هذه الخوارزمية على بيتكوين (Bitcoin)، من الضروري تقدير قيمة معقولة لنسبة الاحتياطي، R، بناءً على الاستخدام الفعلي. إستناداً إلى إجمالي إحتياطي بيتكوين الذي يساوي 15 مليون بيتكوين(BTC) وحجم المعاملة اليومي الذي يساوي 400 ألف بيتكوين[^10]، يمكننا أن نحصل على معدل احتياطي أدنى يبلغ 38 للبيتكوين. باستخدام المعادلات يمكننا حساب النطاق الترددي الأسبوعي (بالبايت) المسموح به لكل بيتكوين (BTC) ليكون:
...
بما أن R = 38 هو الحد الأدنى لنسبة الاحتياطي، فإن CLR/S هو الحد الأدنى لِسِعة عرض النطاق المسموح بها. تقترح دراسة الحالة البسيطة هذه أن المستخدم سيحتاج على الأقل لـ 0.20 بيتكوين (BTC) (أكثر من 80 دولار حتى كتابة هذه السطور) للقيام بمعاملة واحدة في الأسبوع. ومع ذلك، هذا حد علوي غير محكم يستند على إفتراض أن كل البيتكوين (BTC) يمكن تناقله. هذا ليس هو الحال - المستخدمين الذين لديهم عشرات أو مئات البيتكوين لا يجرون بالضرورة عشرات أو مئات المعاملات في الأسبوع! ستؤدي "بقايا" المعاملات التي قام بها هؤلاء المستخدمون "يجب" إلى زيادة نسبة الاحتياطي، مما يسمح "بإعادة تدوير" عرض النطاق الترددي غير المستخدم من أجل المستخدمين الصغار.

جميع التقديرات المذكورة أعلاه هي حدود علوية محافظة، على افتراض أن العملات والإستخدام يتم توزيعهم بشكل متساوٍ نسبيًا. الحقيقة هي أن المستخدمين الذين يمكن إعتبارهم على أنهم الأثقل وزناً مثل ما هو الحال مع منصات التداول، لديهم معدل مرتفع لإستعمال العملة مقارنة بالمستخدمين الأقل وزنا، الأمر الذي يشير في نفس الوقت إلى أن الحد الأدنى الفعلي لمتطلبات الرصيد ستكون أقل بكثير.
...
من الممكن أن يصبح الحساب الذي تم إنشائه في مرحلة ذات إستعمال متدني والذي يحتوي على رصيد منخفض، أن يصبح غير قابل للولوج في حالة ما إذا تضاعف إستخدام الشبكة بشكل كبير. يمكن استرداد الأموال في أي وقت عن طريق تحويل رصيد أكبر إلى الحساب.

من أجل الحفاظ على تجربة مستخدم معقولة مع الحد الأدنى من الحسابات المعلقة، يجب أن تبدأ جميع الحسابات الجديدة مع رصيد 10 أضعاف الحد الأدنى المطلوب للتعامل أسبوعيا. بهذه الطريقة، حتى إذا تضاعف الطلب 10 مرات، ستبقى الحسابات قابلة للإستخدام.
...
الستيم (STEEM) المستخدم لإمداد حساب جديد، سيتم إستعماله من أجل الرفع من طاقة الحساب (أي أنه سيتم تحويل الستيم إلى طاقة الستيم).
...
يجب أن يكون هناك ضغط تصاعدي بطيء ثابت على نسبة الاحتياطي في أي وقت يكون استخدام الشبكة أقل من 50٪ حتى يصل إحتياطي الشبكة إل أقصى درجة. يحدد الحد الأقصى للاحتياطي الحد الأدنى للحصص المطلوبة لإغراق الشبكة في فترات زمنية قصيرة.
...
من ناحية أخرى، يتوقع شخص يملك 50٪ من المنزل أن الطلب على المنزل سوف يزداد في المستقبل، وسوف يتمكن من بيع حصته في المنزل مقابل المزيد. أي مالك يملك منازل أكثر من تلك التي يستعملها، سيصبح مضارب حقيقي في ميدان العقارات. مع هذه العقلية بدلاً من جمع الإيجار، يجمعون التقدير.

يكتسب السهم قيمته من مقدار الوقت الذي يمكن أن يمنحه لمالكه. امتلاك 1٪ من المنزل والحصول عليه لأسبوع واحد في السنة هو أدنى قيمة للسهم. ومع ذلك، إذا كان نصف حاملي الأسهم لا يستخدمونه أبداً في عطلة نهاية الأسبوع، ترتفع قيمة المشاركة بالوقت إلى عُطْلَتَيْ نهاية أسبوع كل عام. إذا بدلا من ذلك إختار هؤلاء المسخدمون الغير نشطين عرض وقتهم الغير مستخدم للإيجار، فستصبح عندها قيمة المشاركة تقدر بـ نهاية عطلة أسبوع واحدة في كل سنة. إذا تم بيع أوقات المشاركة غير المستخدمة للأشخاص الذين سيستخدمونها، فإن قيمتها سوف تنخفض بنسبة 50٪. ما لم يكن الإيجار الذي تم جمعه أكبر من الانخفاض في قيمة الأسهم، فإن مالكي المشاركة بالوقت يقومون بسوء تقدير اقتصادي.

وباستخدام هذا الأساس المنطقي، يمكننا إفتراض أن النظام الذي سيكون قائما على الرسوم، سيكون إما أكثر تكلفة لمستخدميه، أو أقل مردودية لمجمل المُلاك. يمكن للمالك الصغير الفردي أن يستفيد من تأجير شريحته الزمنية الصغيرة، ولكن فقط على حساب جميع أصحاب المشاركة بالوقت الآخرين. في الواقع، يتم تقاسم تكلفة سقوط قيمة المشاركة بالوقت بين جميع المالكين بينما تتركز الأرباح على المالك الوحيد الذي قرر تأجير حصته.
...
من الناحية النظرية يمكن أن تُشَكّل السوق في المكان الذي يُمَكن فيه المستخدمين من إقتراض الحصص المطلوبة. فمن الناحية العملية، يعد شراء وبيع مشاركات الوقت من قبل المستخدمين أكثر فاعلية في تلبية معدل الإستخدام المطلوب. وبعبارة أخرى، تكلفة التفاوض بشأن القروض الصغيرة أكبر من تكلفة المحافظة على توازن مناسب للاستخدام الخاص بك أسبوعيا كحد أقصى.
...
إن التأثير الكلي لهذه النسب المئوية الثابتة على التوزيع والإحتياطي هو أن معدل 800 STEEM في كل دقيقة (تقريبًا) يبقى ساري المفعول لبعض الوقت (كمثال: وحدات ستيم)، ولكنه ينخفض في النسبة المئوية (كمثال: 800 STEEM هو جزء أصغر وأصغر من إجمالي الإحتياطي حيث ينمو إجمالي الإحتياطي أكثر وأكثر). عندما تصل مختلف المكونات الفردية لمعدل 800 ستيم (STEEM) في الدقيقة إلى حدودها الدنيا على أساس النسبة المئوية، فإن كل حد دنيوي (سقف) يوقف التراجع في مكونه من المعدل. ويعني هذا بدوره أنه على المدى الطويل، سيرتفع المعدل الإسمي من 800 ستيم (STEEM) في الدقيقة إلى القيمة (المتغيرة مع الوقت، والمعتمدة على الإحتياطي) اللازمة للحفاظ على معدل نمو سنوي ثابت قدره 10٪ لتحفيز المساهمات، و معدل نمو سنوي ثابت بنسبة 100٪ للتأثير المشترك لتحفيز المساهمات وتحفيز رفع الطاقة. التأثير الكلي هو مضاعفة لإحتياطي ستيم (STEEM) كل عام (ولكن، كما هو مفصل في القسم التالي، إذا قام معضم المستخدمين برفع الطاقة فإن معضم هذه المضاعفة هي "تقسيم" فعال لا ينقل الملكية).

الصورة الإجمالية للإحتياطي معقدة نتيجة لتأثير عمليات دولارات ستيم (SMD)، الأمر الذي قد يؤدي إلى إنشاء أو تدمير ستيم على نطاق واسع من خلال معدل متابعة التحديثات ومكافآت دولارات ستيم (SMD)، كما نوقش في قسم دولارات ستيم (SMD). كما توجد تأثيرات تعقيدات أخرى أصغر حجماً، بما في ذلك الحوافز الغير مطالب بها (مثل مكافآت الكتل للكتل المفقودة)، الضوضاء الناجمة عن حظ المُعَدِّن في إنتاج إثبات العمل، وتأثيرات التغييرات في طول قائمة إنتظار التعدين بسبب التغيير في إجمالي طاقة التجزئة (hashpower) في الشبكة.

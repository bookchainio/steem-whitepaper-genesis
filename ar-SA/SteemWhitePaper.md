...
يمكن للشبكة الاجتماعية أن تضاعف القيمة المستخرجة من مجموعة من المحتوى عن طريق زيادة كمية الروابط وجودتها. التفاعل وتقييم المحتوى مكلف ويستغرق وقتا طويلا في حين أنه من شبه المستحيل أن تعمل الحواسيب في غياب الروابط. تكافئ Steem المستخدمين الذين هم من بين أول من يبحث عن محتوى جديد ويقومون بربطه.
...
Steem هي شبكة لا مركزية يديرها معدنين عبر سلطة قضائية في جميع أنحاء العالم. يتم تسجيل جميع إجراءات المستخدم علنًا على سلسلة الكتل ، ويمكن التحقق منها بشكل علني. هذا يعني أنه لا يوجد كيان واحد يمكنه مراقبة المحتوى الذي يتم تقييمه بواسطة حملة STEEM.

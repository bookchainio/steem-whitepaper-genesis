...
يقدم الدليل الشخصي للعمل مقاربة بديلة لتوزيع عملة تتحسن على أساس * الهدف * التام لأنظمة إثبات العمل مثل التعدين. إن تطبيقات العملة التي تقوم بتطبيق إثبات عمل *شخصي* هي أكبر بكثير من أي نضام إثبات عمل *فعلي* لأنه يمكن تطبيقها لبناء مجتمع حول أي مفهوم له غرض محدد بما فيه كفاية. عندما ينضم الأفراد إلى مجتمع ما، فإنهم يقبلون مجموعة من الآراء ويمكنهم التصويت لتعزيز قيم المجتمع أو غرضه.

في الواقع، المعايير التي يتم من خلالها تقييم العمل هي شخصية تماما ويعيش تعريفها خارج شفرة المصدر نفسها. قد ترغب أحد المجتمعات في مكافأة الفنانين، وقد يرغب مجتمع آخر في مكافأة الشعراء، وآخر يرغب في مكافأة الكوميديين. وقد تختار مجتمعات أخرى أن تكافئ القضايا الخيرية أو تساعد على التقدم في الأجندات السياسية.
...
القضاء على "سوء المعاملة" ليس ممكنا ولا ينبغي أن يكون الهدف. وحتى أولئك الذين يحاولون "إساءة استخدام" النظام فهم لا يزالون يعملون. أي تعويض يحصلون عليه لمحاولاتهم الناجحة في إساءة استخدام النظام أو التواطؤ هو على الأقل ذو قيمة من أجل توزيع العملة كنظام العمل الذي يستخدمه تعدين البيتكوين (Bitcoin) التقليدي أو التعدين الجماعي الذي تقوم به مُجَمَعات(Pool) التعدين. كل ما هو ضروري هو التأكد من أن إساءة الاستخدام ليست متفشية بحيث تقضي تدريجيا على الحافز للقيام بعمل حقيقي لدعم المجتمع وعملته.
...
الاعتبار الأساسي هو تحديد الشهادة المسموح بإدخالها في السجل العام. ينبغي تصميم الانظمة للتقليل من إمكانية الرقابة. المراقبة على السجل العام تشبه منع شخص من التصويت في الانتخابات. في كلتا الحالتين، يتم منع الفرد من التأثير على الإجماع (التوافق) العام.
...
بعد الشهر الأول، يتم الدفع لمعدني ستيم عبر (SP). تصبح طاقة ستيم متاحة للتداول عبر تحويلها لستيم في عملية تستغرق سنتين. وهذا يعني أن المعدنين يجب أن ينتظروا لفترة طويلة، على الأرجح عدة أشهر، قبل أن يتم تحويل مكافآت التعدين الكافية للسماح لهم باسترداد تكلفة الكهرباء والموارد الحاسوبية. إن عملية التحويل لا تشجع إنشاء مُجمعات(pool) التعدين، لأن مشغل المُجمع(pool) يجب أن يوزع المدفوعات على مدار سنوات.
...
تتطلب خوارزمية التعدين التي اعتمدتها ستيم (Steem) أن يكون لدى المعدن حق الوصول إلى المفتاح الخاص للحساب الذي سيحصل على المكافآت. هذا الشرط له عدة عواقب مهمة. أولا، أنها تشجع على تحسين خوارزمية التحقق من المنحنى الإهليلجي(Elliptic curve) التي تحتاجها ستيم (Steem). ثانياً، أنها تجعل من الصعب إنشاء مُجَمَع(Pool) التعدين لأن مشغل المُجَمَع التعديني يجب أن يتشارك السيطرة على المكافآت مع جميع المعدنين "المجهولين". ثالثًا، إنها تجعل استخدام شبكات البوتات (botnets) أمرًا صعبًا للغاية، والسبب هو أن مشغلي شبكات البوت (botnet) يجب أن ينشروا مفاتيحهم الخاصة عبر جميع الأجهزة المخترقة.
...
### مقاومة مُجَمَع(Pool) عملية التعدين

...
التحدي الذي يُواجهه ستيم هو إستخلاص خوارزمية لتسجيل المساهمات الفردية التي يعتبرها معظم أفراد المجتمع تقييما عادلا للقيمة الذاتية لكل مساهمة. و في عالم مثالي، سيتعاون أعضاء المجتمع المحلي لتقييم مساهمة بعضهم البعض و الحصول على تعويض عادل. في العالم الحقيقي، يجب أن يكون تصميم الخوارزميات على نحو يجعلها مقاومة للتلاعب المتعمد من أجر الربح. Any widespread abuse of the scoring system could cause community members to lose faith in the perceived fairness of the economic system.

...
نظرًا لأنه يتم توزيع 90٪ من STEEM الذي تم إنشاؤه على حاملي SP ، فإن النتيجة تشبه وجود "انقسام" بنسبة 2:1 كل عام بدلاً من التضخم الحقيقي. The total rate of expenditures used to reward contributors is about 10% of the market capitalization per year, a rate well below what Bitcoin sustained for the first 7 years after it launched.

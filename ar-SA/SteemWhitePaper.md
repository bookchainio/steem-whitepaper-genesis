...
5% من معدل 100% من النمو السنوي في الإحتياطي الإفتراضي لستيم (STEEM) هو على شكل دولارات ستيم (SMD). يمثل دولار ستيم (SMD) التزامًا بإنشاء STEEM بقيمة 1 دولار أمريكي في المستقبل دون التأثير على كمية STEEM في السوق اليوم. قد يؤثر التغير في نسبة الدين إلى الملكية على قيمة STEEM المتصورة، ولكن هذا لا يؤدي مباشرة إلى انخفاض في قيمة STEEM. If the value of Steem rises over time, then the amount of STEEM that may be created in the future will be less and the corresponding "inflation" never actually happened.

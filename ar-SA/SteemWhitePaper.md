...
في نهاية المطاف، يتم تعدين العديد من عملات إثبات العمل بواسطة شبكات البوتات (botnets). A botnet is a collection of thousands or millions of machines that have been compromised by hackers. These hackers steal the computational and electrical resources of compromised machines to mine cryptocurrency tokens.

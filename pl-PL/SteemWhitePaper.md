...
Wyobraźcie sobie sytuację, w której serwisy, z których codziennie korzystamy, naliczałyby opłaty za każdym razem, gdy podejmujemy jakąś akcję, np. zmieniamy hasło. Użytkownicy oczekują, że pewne rzeczy pozostaną darmowe. Requiring users to make a decision on whether or not an action is worth a small fee creates anxiety that causes users to leave.

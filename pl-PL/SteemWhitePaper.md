...
Zakładając, że wszyscy użytkownicy mają równą stawkę, osoba, która otrzymuje tylko swój głos, otrzyma znacznie mniej niż osoba, która otrzyma głosy od 100 różnych użytkowników. Zachęca to użytkowników do *współpracy*, aby głosować na te same sprawy, aby zmaksymalizować wypłatę. This system also creates financial incentive to *collude* where everyone votes on one thing and then divides the reward equally among themselves.

...
Balanse SP nie mogą być transferowane i są niepodzielne, z wyjątkiem automatycznych, cyklicznych żądań konwersji. Oznacza to, że SP nie może być łatwo wymieniane na giełdach kryptowalut.
...
Ponieważ 90% wszystkich utworzonych STEEM jest dystrybuowanych z powrotem do posiadaczy SP, w rezultacie mamy raczej do czynienia z "podziałem" 2:1 każdego roku, aniżeli z prawdziwą inflacją. Całkowita kwota wydatków przeznaczana na nagradzanie uczestników stanowi około 10% kapitalizacji rynkowej rocznie, tempo znacznie poniżej tego, jakie Bitcoin utrzymywał przez pierwsze 7 lat po jego uruchomieniu.

Utworzenie nowego STEEM celem zmotywowania konkretnego użytkownika lub grupy ma negatywny wpływ na balans procentowego udziału w zaopatrzeniu w STEEM każdego innego użytkownika. Jeśli dokładnie 90% zaopatrzenia STEEM jest przechowywane w SP, to negatywny efekt Motywowania poprzez Wkład na balans posiadaczy SP jest dokładnie równoważony przez pozytywny efekt Motywowania poprzez Zasilanie; Posiadacze SP uzyskują więcej STEEMU (nominalnie), ale ich procentowy udział w łańcuchu (w sensie ułamka całkowitego zaopatrzenia) pozostaje niezmieniony. Jeśli mniej (więcej) niż 90% zaopatrzenia STEEM jest utrzymywane jako SP, oba efekty nadal wskazują przeciwne kierunki, ale efekt dodatni (ujemny) staje się większy, a suma tych dwóch efektów będzie zmierzać do zrównoważenia SP do 90%. To "przyciąganie" nie oznacza, że wartość SP musi długoterminowo utrzymywać się na poziomie 90%, ponieważ odbiorcy nagród będą (i w niektórych przypadkach muszą) przechować STEEM w SP, co oznacza, że "przyciągnięcie" w kierunku 90% nie jest jedyną siłą oddziałowującą na procent zaopatrzenia STEEM przechowywanego jako SP.

Od sierpnia 2008 roku do stycznia roku 2009 podaż pieniądza w Stanach Zjednoczonych [^17] wzrosła z 871 miliardów dolarów do 1,737 biliona dolarów w tempie ponad 100% rocznie, a przez następne 6 lat kontynuowała wzrost w tempie około 20% rocznie. Podsumowując, w ciągu niecałych7 lat podaż pieniądza w Stanach Zjednoczonych wzrosła 4.58 razy. W tym samym czasie, zgodnie z rządowym wskaźnikiem cen towarów i usług konsumpcyjnych [^18] wartość dolara względem dóbr i usług spadła o mniej niż 10%. Ten przykład pokazuje, że podaż jest tylko jednym z komponentów wpływających na cenę.

Cena dóbr cyfrowych, takich jak STEEM, jest podyktowana zarówno popytem jak i podażą. Jeśli nowy STEEM zostanie przyznany tym, którzy stosują strategię długoterminowego przechowywania, wówczas wzrost podaży zostanie zrównoważony przez odpowiedni popyt na przechowywanie. Wpływ tej zmiany podaży zostaje przełożony na przyszłość, kiedy to stosujący strategię długoterminową zdecyduje się sprzedać. Presja sprzedaży jest następnie dystrybuowana przez 2 lata.

Kiedy sotujący strategię długoterminową postanowi sprzedać walutę, podaż STEEM wzrośnie, zbijając cenę. Ten spadek wartości zatrzymuje się, gdy pojawia się nowy długofalowy nabywca, który kupuje STEEM i zamienia je z powrotem na SP. Możemy zatem stwierdzić, że na cenę wpłynie przede wszystkim zmiana popytu na stosowanie strategii długoterminowej przechowywania STEEM.

Spośród 100% rocznego wzrostu wirtualnego zaopatrzenia STEEM 5% jest w formie Dolarów Steem (SMD). SBD reprezentuje zobowiązanie do stworzenia wartości STEEM w dolarach w przyszłości i nie ma wpływu na ilość STEEM na rynku w dniu dzisiejszym. Zmiana wskaźnika zadłużenia do własności może wpłynąć na postrzeganą wartość STEEM, ale nie oznacza bezpośrednio spadku wartości STEEM. Jeśli wartość Steema wzrasta z czasem, to ilość STEEM, która może zostać utworzona w przyszłości, będzie mniejsza, a odpowiednia "inflacja" nigdy nie nastąpi.
...
Przez pierwsze 2 lata życia platformy Bitcoin, sieć utrzymywała roczną stopę inflacyjną [^20] wynoszącą ponad 100%. Przez pierwszych 5 lat było to ponad 30%, zaś w skali pierwszych 8 lat było to ponad 10%. Zgodnie z narzędziem do szacowania przyszłej inflacji zawartym w kodzie źródłowym Steema, Steem przez kontrast osiągnie natychmiastową roczną stopę w wysokości około 12% po zaledwie 1 roku (bez uwzględnienia efektów operacji SBD).

### Księgowość w Steem

Wzrost podaży STEEM jest głównie artefaktem księgowym stworzonym przez chęć uniknięcia naliczania ujemnych stóp procentowych na płynnym STEEM. Ujemne stopy procentowe skomplikowałyby sprawy związane z wymianami, co doprowadziłoby do konieczności korygowania sald użytkowników, aby uwzględnić ujemną stopę zwrotu STEEM utrzymywaną w depozycie. Naśladowanie logiki blockchaina byłoby podatne na błędy i skomplikowałoby integrację i adopcję. Therefore, STEEM has chosen to never charge someone's account, but instead to increase supply. This achieves a similar economic result without forcing everyone accepting STEEM deposits to implement negative interest rates on their internal ledger.

...
Możemy z tego wywnioskować, że blockchain jest najlepiej obsługiwany poprzez nie używanie jakichkolwiek opłat. If a usage fee were to be charged as an alternative to rate limiting, then it should be the equivalent of buying enough timeshares and committing to hold them long enough to gain the right use it once.

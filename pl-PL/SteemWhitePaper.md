...
Cena dóbr cyfrowych, takich jak STEEM, jest podyktowana zarówno popytem jak i podażą. Jeśli nowy STEEM zostanie przyznany tym, którzy stosują strategię długoterminowego przechowywania, wówczas wzrost podaży zostanie zrównoważony przez odpowiedni popyt na przechowywanie. The impact of this change in supply is postponed until a future date when the long-term holder decides to sell. The sell pressure is then distributed over 2 years.

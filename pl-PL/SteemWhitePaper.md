...
Spośród 100% rocznego wzrostu wirtualnego zaopatrzenia STEEM 5% jest w formie Dolarów Steem (SMD). SBD reprezentuje zobowiązanie do stworzenia wartości STEEM w dolarach w przyszłości i nie ma wpływu na ilość STEEM na rynku w dniu dzisiejszym. Zmiana wskaźnika zadłużenia do własności może wpłynąć na postrzeganą wartość STEEM, ale nie oznacza bezpośrednio spadku wartości STEEM. If the value of Steem rises over time, then the amount of STEEM that may be created in the future will be less and the corresponding "inflation" never actually happened.

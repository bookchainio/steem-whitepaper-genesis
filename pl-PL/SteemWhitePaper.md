...
Istnieje kilka kluczowych kwestii które kierowały projektowaniem Steem. Najważniejszą kwestią jest to, że każdy kto kontrybutuje do przedwsięzięcia powinien otrzymać proporcjonalnie własność, płatność lub dług od przedwsięzięcia. This principle is the same principle that is applied to all startups as they allocate shares at founding and during subsequent funding rounds.

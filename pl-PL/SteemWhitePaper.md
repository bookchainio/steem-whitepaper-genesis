...
Przez pierwsze 2 lata życia platformy Bitcoin, sieć utrzymywała roczną stopę inflacyjną [^20] wynoszącą ponad 100%. Przez pierwszych 5 lat było to ponad 30%, zaś w skali pierwszych 8 lat było to ponad 10%. According to the tool for estimating future inflation included with the Steem source code, Steem by contrast will achieve an instantaneous annual rate of approximately 12% after just 1 year (not including the effects of SMD operations).
